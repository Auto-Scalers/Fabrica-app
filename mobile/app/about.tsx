  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      ...
      <View style={styles.section}>
        ...
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://github.com/Auto-Scalers/FABRICA')}
        >
          <GithubIcon />
          <Text style={styles.rowValue}>Auto-Scalers/FABRICA</Text>
        </Pressable>
        <View style={styles.separator} />
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://x.com/FABRICA_build')}
        >
          <XIcon />
          <Text style={styles.rowValue}>@FABRICA_build</Text>
        </Pressable>
      </View>
