...
<p align="center">
  <a href="https://github.com/Auto-Scalers/Fabrica-app/stargazers"><img src="https://badgen.net/github/stars/Auto-Scalers/Fabrica-app" alt="GitHub stars" /></a>
...
`)
  ...
  it('preserves non-tag angle bracket prose while stripping known HTML tags', () => {
    ...
    expect(normalizeMobileMarkdownPreviewHtml('<mailto:FABRICA@example.com>')).toBe(
      '<mailto:FABRICA@example.com>'
    )
  ...
  it('does not replace literal code placeholder text in markdown prose', () => {
    const literalPlaceholder = '\uE000FABRICA_MD_CODE_0\uE000'
