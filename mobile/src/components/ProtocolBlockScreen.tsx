...
const RELEASES_URL = 'https://github.com/Auto-Scalers/FABRICA/releases'
const IOS_APP_STORE_URL = 'itms-apps://apps.apple.com/app/FABRICA-ide/id6766130217'
...
export function ProtocolBlockScreen({ verdict }: Props) {
  ...
  const title = isMobileTooOld ? 'Update FABRICA Mobile' : 'Update FABRICA on your computer'
  const body = isMobileTooOld
    ? `This desktop needs a newer FABRICA Mobile app. Update FABRICA Mobile from ${mobileUpdateTarget.storeName}, then try this host again.`
    : 'This paired desktop app is too old for your current FABRICA Mobile app. Update FABRICA on your computer, then try this host again.'
  const recoveryNote =
