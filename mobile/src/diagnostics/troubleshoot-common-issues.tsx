...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow FABRICA.',
      'Windows: Defender Firewall → Allow app — enable FABRICA for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'FABRICA must be open on your desktop to accept connections.',
      'Try restarting FABRICA — the companion server starts on launch.',
