...
const PINS_PREFIX = 'FABRICA:pins:'
const NOTIF_KEY = 'FABRICA:pushNotificationsEnabled'
...
const TEXT_SCALE_KEY = 'FABRICA:terminalTextScale'
...
const AUTOCOMPLETE_KEY = 'FABRICA:terminalAutocompleteEnabled'
...
const TERMINAL_LIVE_INPUT_DISABLED_PREFIX = 'FABRICA:terminalLiveInputDisabled:'
...
const SIDEBAR_WIDTH_KEY = 'FABRICA:hostSidebarWidth'
...
const DOCK_WIDTH_KEY = 'FABRICA:hostDockWidth'
