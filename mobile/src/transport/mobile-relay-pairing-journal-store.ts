...
const JOURNAL_STORAGE_KEY = 'FABRICA:mobile-relay:pairing-journal:v1'
const JOURNAL_SECRET_KEY = 'FABRICA.mobile-relay.pairing-journal.v1'
...
function requireNativeSecretStore(): void {
  if (Platform.OS === 'web') {
    throw new Error('FABRICA Relay pairing requires a native secret store')
  }
}
