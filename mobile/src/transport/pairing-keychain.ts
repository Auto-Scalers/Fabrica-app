...
const GENERATION_STORAGE_KEY = 'FABRICA:pairing-keychain-generation'
const PRESENCE_STORAGE_PREFIX = 'FABRICA:pairing-keychain-presence:'
const SERVICE_PREFIX = 'FABRICA.pairing.v'
