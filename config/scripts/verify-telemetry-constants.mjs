...
// Asserts that the telemetry compile-time constants — `FABRICA_BUILD_IDENTITY`
// and `FABRICA_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Fabrica.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Fabrica.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `FABRICA_BUILD_IDENTITY` and `FABRICA_POSTHOG_WRITE_KEY` with their
