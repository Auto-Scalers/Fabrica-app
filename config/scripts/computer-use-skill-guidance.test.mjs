...
describe('computer-use skill guidance', () => {
  it('keeps web-app targeting on the computer-use surface', () => {
    ...
    expect(skill).toContain('Use this skill for desktop UI through `fabrica computer`')
    expect(skill).toContain('operate the desktop browser app/window that contains the page')
    expect(skill).not.toContain('fabrica goto')
    expect(skill).not.toContain('fabrica snapshot')
    expect(skill).not.toContain('fabrica click')
    expect(skill).not.toContain('fabrica fill')
