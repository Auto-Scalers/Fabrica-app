...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'Fabrica 모바일 버튼 표시',
    zh: '显示 Fabrica Mobile 按钮',
    ja: 'Fabrica Mobile ボタンを表示'
  },
  ...
  'menu.exploreFabrica': { ko: 'Fabrica 둘러보기', zh: '探索 Fabrica', ja: 'Fabrica を探索' },
  ...
  // Onboarding pill beside Fabrica Mobile: "New" marks a new feature, not a create action.
