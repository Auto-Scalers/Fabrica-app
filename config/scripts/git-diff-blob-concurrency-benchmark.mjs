...
const ITERATIONS = Number(process.env.FABRICA_DIFF_BLOB_BENCH_ITERATIONS ?? '10')
const WARMUP = Number(process.env.FABRICA_DIFF_BLOB_BENCH_WARMUP ?? '3')

for (const [name, value] of [
  ['FABRICA_DIFF_BLOB_BENCH_ITERATIONS', ITERATIONS],
  ['FABRICA_DIFF_BLOB_BENCH_WARMUP', WARMUP]
]) {
