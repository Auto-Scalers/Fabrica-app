...
const ROWS = Number.parseInt(process.env.FABRICA_OWNER_SETTINGS_BENCH_ROWS ?? '43', 10)
const WRITES = Number.parseInt(process.env.FABRICA_OWNER_SETTINGS_BENCH_WRITES ?? '2000', 10)
const WARMUP = Number.parseInt(process.env.FABRICA_OWNER_SETTINGS_BENCH_WARMUP ?? '200', 10)

for (const [name, value] of [
  ['FABRICA_OWNER_SETTINGS_BENCH_ROWS', ROWS],
  ['FABRICA_OWNER_SETTINGS_BENCH_WRITES', WRITES],
  ['FABRICA_OWNER_SETTINGS_BENCH_WARMUP', WARMUP]
]) {
