...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Fabrica IDE': 'Fabrica IDE',
  'Fabrica first': 'Fabrica 优先',
  'Fabrica Mobile': 'Fabrica Mobile',
  'Fabrica logo': 'Fabrica 标志',
  'Enjoying Fabrica?': '喜欢 Fabrica 吗？',
  'Get to know Fabrica': '了解 Fabrica',
  'Expand Fabrica': '展开 Fabrica',
  'Support Fabrica': '支持 Fabrica',
  'Restarting Fabrica…': '正在重启 Fabrica…',
  'Fabrica Attribution': 'Fabrica 归因',
  'Show Fabrica Mobile Button': '显示 Fabrica Mobile 按钮',
  ...
  "Give agents direct access to Fabrica's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Fabrica 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Fabrica. It is still on your disk.': '来自 Fabrica。它仍保留在您的磁盘上。',
