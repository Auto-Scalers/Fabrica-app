...
const markerPath = process.env.FABRICA_REPRO_SPAWN_MARKER
const exitTriggerPath = process.env.FABRICA_REPRO_EXIT_TRIGGER
const inputMarkerPath = process.env.FABRICA_REPRO_INPUT_MARKER
const agentSessionToken = process.env.FABRICA_REPRO_AGENT_SESSION_TOKEN
