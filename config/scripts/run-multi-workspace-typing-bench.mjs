...
const knobByFlag = {
  '--panes': 'FABRICA_TYPING_BENCH_LOAD_PANES',
  '--rate-kbps': 'FABRICA_TYPING_BENCH_RATE_KBPS',
  '--keys': 'FABRICA_TYPING_BENCH_KEYS',
  '--cadence-ms': 'FABRICA_TYPING_BENCH_KEY_CADENCE_MS',
  '--cpu-workers': 'FABRICA_TYPING_BENCH_CPU_WORKERS',
  '--label': 'FABRICA_TYPING_BENCH_LABEL'
}

const env = { ...process.env, FABRICA_TYPING_BENCH: '1' }
