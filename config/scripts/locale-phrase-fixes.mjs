...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /虎鲸:\/\//g, replacement: 'fabrica://', whenEnIncludes: 'fabrica://' },
    ...
    { pattern: /连接到Fabrica/g, replacement: '连接到 Fabrica', whenEnIncludes: 'Connect to Fabrica' },
    {
      pattern: /开始使用Fabrica/g,
      replacement: '开始使用 Fabrica',
      whenEnIncludes: 'get started with Fabrica'
    },
