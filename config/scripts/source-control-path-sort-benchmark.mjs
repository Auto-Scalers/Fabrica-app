...
const ITERATIONS = Number(process.env.FABRICA_SC_SORT_BENCH_ITERATIONS ?? '25')
const WARMUP = Number(process.env.FABRICA_SC_SORT_BENCH_WARMUP ?? '5')

for (const [name, value] of [
  ['FABRICA_SC_SORT_BENCH_ITERATIONS', ITERATIONS],
  ['FABRICA_SC_SORT_BENCH_WARMUP', WARMUP]
]) {
