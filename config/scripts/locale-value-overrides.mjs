...
export const LOCALE_VALUE_OVERRIDES = {
  es: {
    'Explore Fabrica': 'Explorar Fabrica',
  ...
  ko: {
    ...
    'Connect to Fabrica': 'Fabrica에 연결',
    'USB Devices': 'USB 장치',
  ...
  zh: {
    ...
    'Connect to Fabrica': '连接到 Fabrica',
    'USB Devices': 'USB 设备',
  ...
  ja: {
    ...
    'Connect to Fabrica': 'Fabrica に接続',
    ...
    'Kill all': 'すべて強制終了',
    'kill all': 'すべて終了',
    'Collapse Fabrica': 'Fabrica を折りたたむ',
