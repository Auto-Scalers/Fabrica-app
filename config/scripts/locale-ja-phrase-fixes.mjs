...
// Two-word commands (`git commit`, `fabrica terminal`) must keep their second word in Latin.
const COMMAND_HEAD = '(?<!\\b(?:git|gh|glab|fabrica|npm|pnpm|npx|yarn|docker|kubectl) )'
...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /シャチ:\/\//g, replacement: 'fabrica://', whenEnIncludes: 'fabrica://' },
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Fabrica' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Fabrica' },
  ...
  // Fabrica's host covers SSH hosts and this computer; skipped where the English also says server.
  {
