...
describe('computer-use e2e workflow', () => {
  ...
  it('guards e2e source against fragile fixed waits and stale element indexes', () => {
    ...
    expect(cliDriver).toContain('FABRICA_DEV_USER_DATA_PATH')
    expect(cliDriver).toContain('fabrica-computer-runtime-')
    expect(cliDriver).toContain('retryMissingRuntimeMetadata')
    expect(cliDriver).toContain('Could not read Fabrica runtime metadata')
