...
# Auto-Scalers/Fabrica-hourly. GITHUB_TOKEN cannot be used: it is scoped to the repo
...
# Widening it to cover Auto-Scalers/Fabrica-adhoc / fabrica-daily is
...
MAIN_REPO="Auto-Scalers/Fabrica-app"
HOURLY_REPO="Auto-Scalers/Fabrica-hourly"
...
──────────────────────────────────────────────────────
  1. Open:  https://github.com/organizations/Auto-Scalers/settings/apps/new
  2. Name ..................  fabrica-hourly-release
