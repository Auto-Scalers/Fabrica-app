...
describe('live-remote-bulk-open-freeze-metrics', () => {
  ...
  it('builds worktree selectors from id/path', () => {
    expect(
      worktreeSelector({ id: 'repo::C:/Users/neil/fabrica/fabrica', path: 'C:/Users/neil/fabrica/fabrica' })
    ).toBe('id:repo::C:/Users/neil/fabrica/fabrica')
  ...
  it('rejects invalid numeric environment values', () => {
    process.env.FABRICA_FREEZE_TEST_NUMBER = 'not-a-number'
    expect(() => readFreezeNumberEnv('FABRICA_FREEZE_TEST_NUMBER', 5)).toThrow(
      'Invalid FABRICA_FREEZE_TEST_NUMBER'
    )
    delete process.env.FABRICA_FREEZE_TEST_NUMBER
    expect(readFreezeNumberEnv('FABRICA_FREEZE_TEST_NUMBER', 5)).toBe(5)
  })
