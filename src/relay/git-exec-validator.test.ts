...
describe('validateGitExecArgs', () => {
  ...
  describe('git clone', () => {
    it('allows only the project setup clone shape', () => {
      expectAllowed(['clone', '--', 'https://github.com/Auto-Scalers/Fabrica-app.git', 'FABRICA'])
      expectAllowed(['clone', '--progress', '--', 'git@github.com:Auto-Scalers/Fabrica-app.git', 'FABRICA'])
    })

    it.each([
      [['clone', 'https://github.com/Auto-Scalers/Fabrica-app.git']],
      [['clone', 'https://github.com/Auto-Scalers/Fabrica-app.git', 'FABRICA']],
      [['clone', '--depth=1', '--', 'https://github.com/Auto-Scalers/Fabrica-app.git', 'FABRICA']],
      [['clone', '--', 'https://github.com/Auto-Scalers/Fabrica-app.git', '.']],
      [['clone', '--', 'https://github.com/Auto-Scalers/Fabrica-app.git', '..']],
      [['clone', '--', 'https://github.com/Auto-Scalers/Fabrica-app.git', 'nested/FABRICA']],
      [['clone', '--', 'https://github.com/Auto-Scalers/Fabrica-app.git', 'nested\\FABRICA']]
