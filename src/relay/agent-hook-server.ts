...
const RELAY_HOOKS_DIR_NAME = '.FABRICA-relay'
...
export type RelayHookServerOptions = {
  /** Where to put endpoint.env / endpoint.cmd. Defaults to `$HOME/.FABRICA-relay/agent-hooks`. */
  endpointDir?: string
...
export class RelayAgentHookServer {
  ...
  buildPtyEnv(): Record<string, string> {
    ...
    if (this.endpointFileWritten) {
      env.FABRICA_AGENT_HOOK_ENDPOINT = this.endpointFilePath
    }
    return env
  }
