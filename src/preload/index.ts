...
import {
  FABRICA_INTERNAL_FILE_DRAG_TYPE,
...
document.addEventListener(
  ...
  (e) => {
    ...
    if (e.dataTransfer?.types.includes(FABRICA_INTERNAL_FILE_DRAG_TYPE)) {
      return
    }
...
const api = {
  ...
  FABRICAProfiles: {
    ...
    authStatus: () => ipcRenderer.invoke('FABRICAProfiles:authStatus'),
    createLocal: (args) => ipcRenderer.invoke('FABRICAProfiles:createLocal', args),
    createCloudLinked: (args) => ipcRenderer.invoke('FABRICAProfiles:createCloudLinked', args),
    switchProfile: (args) => ipcRenderer.invoke('FABRICAProfiles:switch', args),
    transferProject: (args) => ipcRenderer.invoke('FABRICAProfiles:transferProject', args),
    findProjectProfiles: (args) => ipcRenderer.invoke('FABRICAProfiles:findProjectProfiles', args),
    connectCurrent: () => ipcRenderer.invoke('FABRICAProfiles:connectCurrent'),
    refreshAuth: () => ipcRenderer.invoke('FABRICAProfiles:refreshAuth'),
    signOutCurrent: () => ipcRenderer.invoke('FABRICAProfiles:signOutCurrent'),
    selectOrg: (args) => ipcRenderer.invoke('FABRICAProfiles:selectOrg', args),
    orgMembersList: (args) => ipcRenderer.invoke('FABRICAProfiles:orgMembersList', args),
    orgMemberInvite: (args) => ipcRenderer.invoke('FABRICAProfiles:orgMemberInvite', args),
    orgInviteRevoke: (args) => ipcRenderer.invoke('FABRICAProfiles:orgInviteRevoke', args),
    orgMemberChangeRole: (args) => ipcRenderer.invoke('FABRICAProfiles:orgMemberChangeRole', args),
  ...
  browser: {
    ...
    onOpenLinkInFABRICATab: (
      ...
      return () => ipcRenderer.removeListener('browser:open-link-in-FABRICA-tab', listener)
    },
