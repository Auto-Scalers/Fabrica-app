...
export type SshTarget = {
  id: string
  label: string
  /** Internal owner for targets that FABRICA creates as implementation details.
...
export type SshConfigHostSummary = {
  ...
  proxyCommand?: string
  jumpHost?: string
  /** True when an FABRICA SSH target already uses this config alias. */
  alreadyInFABRICA: boolean
  /**
   * True when the user deleted this alias from FABRICA (tombstone). Still listed so they
