...
export const HOURLY_RELEASE_REPO = 'Auto-Scalers/Fabrica-hourly'
export const DAILY_RELEASE_REPO = 'Auto-Scalers/Fabrica-daily'
export const ADHOC_RELEASE_REPO = 'Auto-Scalers/Fabrica-adhoc'
