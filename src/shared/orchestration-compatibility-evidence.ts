...
export const ORCHESTRATION_COMPATIBILITY_HOST_KIND_ENV =
  'FABRICA_ORCHESTRATION_COMPATIBILITY_HOST_KIND'
export const ORCHESTRATION_COMPATIBILITY_HOST_ID_ENV = 'FABRICA_ORCHESTRATION_COMPATIBILITY_HOST_ID'
export const ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION_ENV =
  'FABRICA_ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION'
export const ORCHESTRATION_COMPATIBILITY_ATTACHMENT_ENV =
  'FABRICA_ORCHESTRATION_COMPATIBILITY_ATTACHMENT'
...
export function readOrchestrationCompatibilityEvidence(
  ...
  const terminalHandle = boundedValue(env.FABRICA_TERMINAL_HANDLE)
  const paneKey = boundedValue(env.FABRICA_PANE_KEY)
  const launchToken = boundedValue(env.FABRICA_AGENT_LAUNCH_TOKEN)
