...
describe('buildAiVaultResumeCommand', () => {
  ...
  it('carries non-default Codex homes in copied resume commands', () => {
    expect(
      ...
      "cd '/repo/app' && CODEX_HOME='/Users/ada/Library/Application Support/FABRICA/codex-runtime-home/home' codex resume 'session-1'"
    )
    ...
    expect(
      ...
      'cmd /d /s /c "cd /d ""C:\\Users\\Ada Lovelace\\repo"" && set ""CODEX_HOME=C:\\Users\\Ada\\AppData\\Roaming\\FABRICA\\codex-runtime-home\\home"" && codex resume ""session-1"""'
    )
  })
