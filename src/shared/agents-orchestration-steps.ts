// Per-step copy for the agents-orchestration tile in the Explore FABRICA modal.
...
export const AGENTS_STEPS: readonly AgentsStep[] = [
  ...
  },
  {
    ...
    description: 'Enable agents to manage and coordinate FABRICA workspaces to execute larger tasks.'
  },
  {
    id: 'usage',
    name: 'Usage',
