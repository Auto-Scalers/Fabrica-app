 ...
 * local `fabrica` rename — which exists solely to avoid shadowing the
 * GNOME FABRICA screen reader on a local desktop — must not be applied to those
 * remotes, or `fabrica claude-teams` lands on a PATH where it does not exist.
