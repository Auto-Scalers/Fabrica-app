...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'FABRICA’s built-in prompt for this action, including the context FABRICA knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the FABRICA workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when FABRICA has one available.',
