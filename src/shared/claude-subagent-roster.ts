...
export type TrackedClaudeSubagent = {
   ...
   *  observed (FABRICA restart). A present complete task list omitting it
 ...
 *    never saw start (FABRICA/relay restart mid-run) → recreate it;
 ...
 *  `background_tasks` list; a parent that went idle before FABRICA restarted never
