...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://www.onFABRICA.dev/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    docsUrl: 'https://www.onFABRICA.dev/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://www.onFABRICA.dev/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
  ...
  },
  {
    ...
    owner: 'FABRICA-cli',
    docsUrl: 'https://www.onFABRICA.dev/docs/cli/overview'
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://www.onFABRICA.dev/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://www.onFABRICA.dev/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://www.onFABRICA.dev/docs/editing/viewers'
  }
] as const
