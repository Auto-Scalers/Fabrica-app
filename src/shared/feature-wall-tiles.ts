...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://fabrica-ai.vercel.app/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    caption:
      'Run agents on a remote machine with the same FABRICA editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
    posterPath: 'tile-06.poster.jpg',
    recordedAtPath: 'tile-06.recorded-at.json',
    owner: 'ssh-workspaces',
    docsUrl: 'https://fabrica-ai.vercel.app/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://fabrica-ai.vercel.app/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
  ...
  },
  {
    ...
    kind: 'media',
    title: 'FABRICA CLI',
    caption: 'Agents can drive FABRICA too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
    posterPath: 'tile-09.poster.jpg',
    recordedAtPath: 'tile-09.recorded-at.json',
    owner: 'FABRICA-cli',
    docsUrl: 'https://fabrica-ai.vercel.app/docs/cli/overview'
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://fabrica-ai.vercel.app/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://fabrica-ai.vercel.app/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://fabrica-ai.vercel.app/docs/editing/viewers'
  }
] as const
