...
// Why: a headed FABRICA server keeps answering status.get after its workspace window
...
// window exists (FABRICA-runtime.ts:4806), so pairing it with a non-ready graph is the
