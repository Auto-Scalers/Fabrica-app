...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use FABRICA's browser",
    subtitle: "Use FABRICA's browser",
    description:
      'Browse your web app without leaving FABRICA. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable FABRICA CLI',
    subtitle: 'Enable FABRICA CLI',
    description:
      'Register the FABRICA shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into FABRICA so you can start agent work without hunting for folders.'
  }
] as const
