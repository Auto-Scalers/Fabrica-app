...
export const PANEL_ACTION_REQUEST_TYPE = 'FABRICA-panel-action'
export const PANEL_ACTION_RESULT_TYPE = 'FABRICA-panel-action-result'
export const PANEL_PING_TYPE = 'FABRICA-panel-ping'
export const PANEL_PONG_TYPE = 'FABRICA-panel-pong'
export const PLUGIN_PANEL_FRAME_NAME_PREFIX = 'FABRICA-plugin-panel:'
