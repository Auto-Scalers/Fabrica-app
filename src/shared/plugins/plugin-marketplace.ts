...
export const PLUGIN_MARKETPLACE_FILENAME = 'fabrica-marketplace.json'
export const PLUGIN_MARKETPLACE_ENTRY_LIMIT = 2_048
export const PLUGIN_MARKETPLACE_CATEGORY_LIMIT = 16

export const OFFICIAL_PLUGIN_PUBLISHER = 'autoscalers'
export const OFFICIAL_PLUGIN_ID_PREFIX = 'fabrica-'
...
export const OFFICIAL_MARKETPLACE_GIT_SOURCE: PluginMarketplaceGitSource = {
  kind: 'git',
  url: 'https://github.com/Auto-Scalers/fabrica-plugins.git',
  ref: 'main'
}
