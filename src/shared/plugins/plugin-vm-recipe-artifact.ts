import { z } from 'zod'
import { FABRICA_VM_RECIPE_ID_PATTERN, FABRICA_VM_RECIPE_ID_RULE } from '../fabrica-yaml'
import type { FABRICAVmRecipe } from '../types'
...
const pluginVmRecipeArtifactSchema = z
  .object({
    ...
    id: z.string().regex(FABRICA_VM_RECIPE_ID_PATTERN, FABRICA_VM_RECIPE_ID_RULE),
...
export function parsePluginVmRecipeArtifact(raw: string): FABRICAVmRecipe {
...
export function listPluginVmRecipeCommands(recipe: FABRICAVmRecipe): PluginVmRecipeCommand[] {
  return [
