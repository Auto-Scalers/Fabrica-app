...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote FABRICA runtime|remote FABRICA runtime closed the connection|timed out (?:waiting for|while connecting to) the remote FABRICA runtime/i
