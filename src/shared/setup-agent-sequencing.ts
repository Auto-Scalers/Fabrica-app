...
export const SETUP_AGENT_SEQUENCE_STARTUP_COMMAND_ENV = 'FABRICA_SEQUENCED_STARTUP_COMMAND'
export const SETUP_AGENT_SEQUENCE_STARTUP_SCRIPT_ENV = 'FABRICA_SEQUENCED_STARTUP_SCRIPT'
...
function buildWindowsSetupCommand(
  ...
  const script = [
    ...
    '$processInfo.Arguments = \'/d /s /v:on /c ""!FABRICA_SETUP_RUNNER!""\'',
    '$processInfo.UseShellExecute = $false',
    '$processInfo.EnvironmentVariables["FABRICA_SETUP_RUNNER"] = $runner',
