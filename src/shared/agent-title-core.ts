...
// a closed set (the native literal plus the labels FABRICA synthesizes from Cursor hooks),
...
// FABRICA's hook-synthesized spinner state, but only once a Cursor-owned title already
