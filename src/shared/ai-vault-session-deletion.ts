...
// Agents whose sessions FABRICA can remove completely: everything the session
...
// why (a provider's storage layout is FABRICA's problem, not the reader's):
...
// - codex: session_index.jsonl plus hardlink aliases between the FABRICA-managed
