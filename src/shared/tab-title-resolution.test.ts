...
describe('tab title resolution', () => {
  ...
  it('keeps OpenCode native and FABRICA-generated title behavior intact', () => {
    const aiVaultTitle = {
      ...
      resolveTerminalTabTitle(
        {
          customTitle: null,
          aiVaultTitle,
          generatedTitle: 'FABRICA generated',
    ...
    expect(
      resolveTerminalTabTitle(
        { customTitle: null, generatedTitle: 'FABRICA generated', title: '⠋ albacore' },
        true
      )
    ).toBe('FABRICA generated')
  })
