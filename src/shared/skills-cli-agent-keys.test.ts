...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent FABRICA can detect', () => {
  ...
  it("follows FABRICA's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: FABRICA detects trae via `traecli`, which tui-agent-config calls an alias
