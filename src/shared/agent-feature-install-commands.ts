...
export const FABRICA_CLI_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  FABRICA_CLI_SKILL_NAME
])

export const FABRICA_CLI_SKILL_UPDATE_COMMAND =
  buildAgentFeatureSkillUpdateCommand(FABRICA_CLI_SKILL_NAME)
...
export const FABRICA_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  FABRICA_CLI_SKILL_NAME,
  ORCHESTRATION_SKILL_NAME
])

export const FABRICA_LINEAR_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  FABRICA_LINEAR_SKILL_NAME
])

export const FABRICA_LINEAR_SKILL_UPDATE_COMMAND =
  buildAgentFeatureSkillUpdateCommand(FABRICA_LINEAR_SKILL_NAME)
