...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__FABRICA_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__FABRICABrowserAnnotationViewportBridge';
  const hostAttribute = 'data-FABRICA-browser-annotation-overlay';
  const markerSize = 24;
