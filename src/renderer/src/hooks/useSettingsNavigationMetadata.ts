...
import { FabricaLogoSettingsIcon } from '@/components/settings/fabrica-logo-settings-icon'
...
import { getFABRICAAccountSettingsSearchEntries } from '@/components/settings/fabrica-account-settings-search'
  ...
  return [
      ...
      ? [
          {
            ...
            searchEntries: getFABRICAAccountSettingsSearchEntries(),
            group: 'setup'
          }
        ]
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core Fabrica workflows.'
      ),
      icon: FabricaLogoSettingsIcon,
      searchEntries: [
        {
          title: translate(
            'auto.hooks.useSettingsNavigationMetadata.ded9e9032f',
    ...
    // multiple hosts (local + a Remote FABRICA Server, or two clones) collapses to
