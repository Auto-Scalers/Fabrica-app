export const FABRICA_TERMINAL_COMMAND_FINISHED_EVENT = 'FABRICA:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(FABRICA_TERMINAL_COMMAND_FINISHED_EVENT, {
