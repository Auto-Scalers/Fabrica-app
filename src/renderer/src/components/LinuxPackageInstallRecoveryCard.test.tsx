...
const RELEASE_URL = 'https://github.com/Auto-Scalers/Fabrica-app/releases/tag/v1.4.200'
...
describe('LinuxPackageInstallRecoveryCard copy', () => {
  it('leads with the recovery copy and the three dedicated actions', () => {
    ...
    expect(
      screen.getByText(/a system terminal on the computer where Fabrica is installed/)
    ).toBeTruthy()
    expect(screen.getByText(/quit and reopen Fabrica to run the new version/)).toBeTruthy()
