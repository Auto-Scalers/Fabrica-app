...
const sections: SettingsNavSection[] = [
  {
    ...
    searchEntries: [
      {
        title: 'Fabrica CLI',
        description: 'Register or remove the FABRICA shell command.',
  ...
  {
    id: 'servers',
    title: 'Remote Fabrica Servers',
    description: 'Pair remote Fabrica runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote Fabrica Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
...
describe('Cmd+J palette middle-band ranking', () => {
  it.each([
    ...
    ['FABRICA cli', 'settings:general:cli'],
    ...
    const integrationSections: SettingsNavSection[] = [
      {
        id: 'linear',
        title: 'Linear',
        description: 'How Linear works in Fabrica.',
        icon: Settings,
        searchEntries: [],
        group: 'capabilities'
      },
