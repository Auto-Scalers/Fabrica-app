...
vi.mock('@/hooks/useVirtualizedScrollAnchor', () => ({
  VIRTUALIZED_SCROLL_ANCHOR_RECORD_EVENT: 'FABRICA:test-record-scroll-anchor',
...
vi.mock('./WorktreeCardAgents', () => ({
  ...
  SUPPRESS_WORKTREE_LIST_SCROLL_ADJUSTMENT_EVENT: 'FABRICA:test-suppress-scroll-adjustment'
}))

vi.mock('./WorktreeContextMenu', () => ({
  default: ({ children }: { children: ReactNode }) => <>{children}</>,
  CLOSE_ALL_CONTEXT_MENUS_EVENT: 'FABRICA:test-close-context-menus',
  WORKTREE_CONTEXT_MENU_SCOPE_ATTR: 'data-FABRICA-context-menu-scope',
...
function makeHostedReview(overrides: Partial<HostedReviewInfo> = {}): HostedReviewInfo {
  return {
    ...
    state: 'open',
    url: 'https://gitlab.com/acme/FABRICA/-/merge_requests/42',
    status: 'success',
