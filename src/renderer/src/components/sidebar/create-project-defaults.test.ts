...
describe('create project defaults', () => {
  it('builds the POSIX default project parent', () => {
    expect(getDefaultCreateProjectParent('/Users/alice')).toBe('/Users/alice/FABRICA/projects')
  })

  it('builds the Windows default project parent', () => {
    expect(getDefaultCreateProjectParent('C:\\Users\\alice')).toBe(
      'C:\\Users\\alice\\FABRICA\\projects'
    )
  })

  it('derives the runtime project default from a resolved server home', () => {
    expect(getDefaultCreateProjectParent('/home/alice')).toBe('/home/alice/FABRICA/projects')
  })

  it('joins path previews without mixing separators', () => {
    expect(joinCreateProjectPath('/home/alice/FABRICA/projects', 'demo')).toBe(
      '/home/alice/FABRICA/projects/demo'
    )
    expect(joinCreateProjectPath('C:\\Users\\alice\\FABRICA\\projects', 'demo')).toBe(
      'C:\\Users\\alice\\FABRICA\\projects\\demo'
    )
  })
  ...
  it('auto-fills only the first empty local create step', () => {
    expect(
      getCreateProjectDefaultParentAutoFill({
        ...
        defaultParent: '/Users/alice/FABRICA/projects',
        createStepAutoFilled: false
      })
    ).toEqual({ parent: '/Users/alice/FABRICA/projects' })
    expect(
      getCreateProjectDefaultParentAutoFill({
        step: 'create',
  ...
  it('uses a short local summary only for the local default parent', () => {
    expect(
      formatCreateProjectParentSummary({
        parent: '/Users/alice/FABRICA/projects',
        defaultParent: '/Users/alice/FABRICA/projects'
      })
    ).toBe('~/FABRICA/projects')
    expect(
      formatCreateProjectParentSummary({
        parent: '',
        defaultParent: '',
    ...
    ).toBe('/Users/alice/FABRICA/projects')
    expect(
      formatCreateProjectParentSummary({
        parent: '',
        defaultParent: '',
