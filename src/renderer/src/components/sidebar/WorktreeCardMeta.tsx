      ...
      >
        <SelectedTextCopyMenu className="space-y-3">
          ...
          <WorktreeCardIssueDetailSection
            ...
            onOpenGitHubIssueInFABRICA={
              onOpenGitHubIssueInFABRICA ? dismissAndRun(onOpenGitHubIssueInFABRICA) : undefined
            }
          />
          ...
          {linearIssue && (
            <WorktreeCardDetailSection>
              <DetailHeader
                ...
                actions={
                  <>
                    {linearIssue.url && onOpenLinearIssueInFABRICA && (
                      <MetadataActionIcon
                        label={translate(
                          'auto.components.sidebar.WorktreeCardMeta.2c67730e07',
                          'Open in Fabrica'
                        )}
                        onClick={dismissAndRun(onOpenLinearIssueInFABRICA)}
                      >
          ...
          <WorktreeCardReviewDetailSection
            ...
            onOpenReviewInFABRICA={onOpenReviewInFABRICA}
