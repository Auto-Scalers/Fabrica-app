...
const remoteWorktree: Worktree = {
  ...
  path: '/home/alice/FABRICA-feature',
...
describe('getPRGroupKey', () => {
  ...
  it('prefers repo-scoped PR status over stale legacy path-scoped status', () => {
    const prCache = {
      '/tmp/FABRICA::feature/super-critical': {
        data: { state: 'closed' }
      },
      'repo-1::feature/super-critical': {
        data: { state: 'merged' }
...
describe('buildRows with pinned worktrees', () => {
  ...
  it('orders project identity headers by the manual repo order anchor', () => {
    const analyticsProject: Project = {
      ...project,
      id: 'github:Auto-Scalers/analytics',
    ...
    const analyticsRepo: Repo = {
      ...
      path: '/tmp/analytics',
      displayName: 'analytics',
      upstream: { owner: 'Auto-Scalers', repo: 'analytics' }
    }
    ...
    expect(headers.map((row) => row.key)).toEqual([
      ...
      'project:github:Auto-Scalers/analytics'
    ])
  ...
  it('splits same-host checkouts of one project into separate per-setup groups', () => {
    const repoB: Repo = { ...repo, id: 'repo-2', path: '/tmp/FABRICA-2', displayName: 'FABRICA-2' }
    const worktreeB: Worktree = {
      ...worktree,
      id: 'wt-2',
      repoId: repoB.id,
      path: '/tmp/FABRICA-2-feature',
  ...
  it('counts projection twins for one directory as one checkout', () => {
    ...
    const runtimeRepo: Repo = {
      ...remoteRepo,
      id: 'repo-runtime',
      path: '/home/alice/FABRICA-runtime',
    ...
    const runtimeWorktree: Worktree = {
      ...
      id: 'wt-runtime',
      repoId: runtimeRepo.id,
      path: '/home/alice/FABRICA-runtime-feature'
    }
  ...
  it('keeps Git hosts grouped when folder setups share the project identity', () => {
    ...
    expect(new Set(groupKeys)).toEqual(new Set(['project:github:Auto-Scalers/Fabrica-app']))
  })
  ...
  it('keeps a provisioned runtime copy under the project header alongside a same-host checkout', () => {
    const runtimeRepoB: Repo = {
      ...repo,
      id: 'repo-runtime-b',
      path: '/tmp/FABRICA-runtime-b',
      displayName: 'FABRICA-runtime-b'
    }
    const runtimeWorktreeB: Worktree = {
      ...worktree,
      id: 'wt-runtime-b',
      repoId: runtimeRepoB.id,
      path: '/tmp/FABRICA-runtime-b-feature',
  ...
  it('groups Windows host and WSL setups on the same runtime host', () => {
    ...
    const windowsRepo: Repo = {
      ...repo,
      id: 'repo-windows',
      path: String.raw`C:\Users\alice\git\FABRICA`,
      displayName: 'FABRICA',
      executionHostId: runtimeHostId
    }
    const wslRepo: Repo = {
      ...repo,
      id: 'repo-wsl',
      path: String.raw`\\wsl.localhost\Ubuntu\home\alice\git\FABRICA`,
      displayName: 'FABRICA',
      executionHostId: runtimeHostId
    }
    const windowsWorktree: Worktree = {
      ...
      id: 'wt-windows',
      repoId: windowsRepo.id,
      path: String.raw`C:\Users\alice\git\FABRICA\feature`
    }
    const wslWorktree: Worktree = {
      ...worktree,
      id: 'wt-wsl',
      repoId: wslRepo.id,
      path: String.raw`\\wsl.localhost\Ubuntu\home\alice\git\FABRICA\feature`
    }
  ...
  it('uses saved host labels for mixed-host sidebar card badges', () => {
    const runtimeRepo: Repo = {
      ...remoteRepo,
      id: 'repo-runtime',
      path: '/Users/alice/runtime-FABRICA',
      connectionId: null,
  ...
  it('shows distinct Fabrica server names when status grouping mixes runtime hosts', () => {
  ...
  it('keeps same-named repos separate without project setup identity', () => {
    const rows = buildRows(
      ...
      [worktree, remoteWorktree],
      new Map([
        [repo.id, { ...repo, displayName: 'FABRICA' }],
        [remoteRepo.id, { ...remoteRepo, displayName: 'FABRICA' }]
      ]),
      null,
      new Set()
    )
  ...
  it('returns project group keys for worktree reveal when project setup identity exists', () => {
    ...
    ).toBe('project:github:Auto-Scalers/Fabrica-app')
  })
  ...
  it('emits an empty ungrouped repo placeholder before imported cards are merged', () => {
    ...
    expect(rows).toMatchObject([
      { type: 'header', key: 'repo:repo-1', label: 'FABRICA' },
      {
        type: 'imported-worktrees-card',
        key: 'imported-worktrees-card:repo-group:repo-1',
        placement: 'repo-group'
...
describe('buildRows workspace lineage nesting', () => {
  ...
  it('nests stable-update resolved legacy lineage when generalized lineage is absent', () => {
    const parentId =
      '32a0226d-9f33-42e8-8b7b-24867dea06d4::/Users/jinwoo/FABRICA/workspaces/FABRICA/assigned-issues'
    const childId =
      '32a0226d-9f33-42e8-8b7b-24867dea06d4::/Users/jinwoo/FABRICA/workspaces/FABRICA/issue-9276-nested-ssh-runtime-routing'
    const secondChildId =
      '32a0226d-9f33-42e8-8b7b-24867dea06d4::/Users/jinwoo/FABRICA/workspaces/FABRICA/issue-9744-terminal-close-lifecycle'
