// Step for AddRepoDialog (FABRICA#763), split out so create-project state stays scoped.
      ...
      <DialogHeader>
        ...
        <DialogDescription>
          {translate(
            ...
            'Name it and Fabrica will create a real project with sensible defaults.'
          )}
        </DialogDescription>
      </DialogHeader>
