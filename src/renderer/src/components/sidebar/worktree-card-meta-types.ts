...
export type WorktreeCardDetailsHoverProps = WorktreeCardMetaBadgesProps & {
  ...
  onOpenGitHubIssueInFABRICA?: (event: React.MouseEvent) => void
  onOpenLinearIssueInFABRICA?: (event: React.MouseEvent) => void
  onOpenReviewInFABRICA?: (event: React.MouseEvent) => void
  onUnlinkReview?: () => void
