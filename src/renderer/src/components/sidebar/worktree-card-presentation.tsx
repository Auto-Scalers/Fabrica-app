...
export function buildWorktreeCardPresentation(card: WorktreeCardController) {
  const {
    ...
    handleEditIssue,
    handleEditComment,
    handleOpenGitHubIssueInFABRICA,
    handleOpenLinearIssueInFABRICA,
    handleOpenReviewInFABRICA,
    ...
    : compactCards && (showBranchIdentityHover || hasDetails || hasPorts)
      ? (title: React.ReactElement): React.ReactElement => (
          <WorktreeCardDetailsHover
            ...
            onOpenGitHubIssueInFABRICA={
              metaIssue && 'url' in metaIssue && metaIssue.url
                ? handleOpenGitHubIssueInFABRICA
                : undefined
            }
            onOpenLinearIssueInFABRICA={linearIssue?.url ? handleOpenLinearIssueInFABRICA : undefined}
            onOpenReviewInFABRICA={
  ...
  const detailsAndPorts =
    detailsAndPortsContent && !newCardStyle ? (
      <WorktreeCardDetailsHover
        ...
        onEditComment={affiliateListMode ? undefined : handleEditComment}
        onOpenGitHubIssueInFABRICA={
          metaIssue && 'url' in metaIssue && metaIssue.url ? handleOpenGitHubIssueInFABRICA : undefined
        }
        onOpenLinearIssueInFABRICA={linearIssue?.url ? handleOpenLinearIssueInFABRICA : undefined}
        onOpenReviewInFABRICA={
          metaReview?.url && metaReview.provider === 'github' ? handleOpenReviewInFABRICA : undefined
        }
        onOpenAutomation={affiliateListMode ? undefined : handleOpenAutomation}
        onOpenAutomationRun={affiliateListMode ? undefined : handleOpenAutomationRun}
