...
describe('WorktreeCardDetailsHover', () => {
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        review={{
          ...
          state: 'open',
          url: 'https://github.com/acme/FABRICA/pull/456',
          status: 'success',
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        issue={{
          ...
          state: 'open',
          url: 'https://github.com/acme/FABRICA/issues/5518',
          labels: []
        }}
        linearIssue={null}
        review={null}
  ...
  it('puts unlink behind the first PR actions menu and keeps GitHub last', () => {
    ...
    const openInFABRICAIndex = markup.indexOf('aria-label="Open in Fabrica"')
    ...
    expect(moreActionsIndex).toBeLessThan(openInFABRICAIndex)
    expect(openInFABRICAIndex).toBeLessThan(viewOnGitHubIndex)
  ...
  it('puts issue copy menu before edit and open actions and keeps GitHub last', () => {
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        onEditIssue={vi.fn()}
        onEditComment={vi.fn()}
        onOpenGitHubIssueInFABRICA={vi.fn()}
      >
    ...
    expect(editIssueIndex).toBeLessThan(openInFABRICAIndex)
    expect(openInFABRICAIndex).toBeLessThan(viewOnGitHubIndex)
  })
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        review={{
          ...
          state: 'open',
          url: 'https://gitlab.com/acme/FABRICA/-/merge_requests/77',
          status: 'success'
        }}
        comment={null}
        onEditIssue={vi.fn()}
  ...
  it('displays Linear issue details with link', () => {
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        onEditIssue={vi.fn()}
        onEditComment={vi.fn()}
        onOpenLinearIssueInFABRICA={vi.fn()}
      >
        <span>ENG-123</span>
      </WorktreeCardDetailsHover>
    )
