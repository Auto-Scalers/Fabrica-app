...
export const WORKSPACE_STATUS_DRAG_TYPE = 'application/x-FABRICA-worktree-id'
export const WORKSPACE_STATUS_DRAG_IDS_TYPE = 'application/x-FABRICA-worktree-ids'
