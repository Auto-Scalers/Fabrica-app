...
const WORKSPACE_BOARD_MOVED_HINT_STORAGE_KEY = 'FABRICA.workspaceBoardMovedHintSeen.v1'
...
const SidebarToolbar = React.memo(function SidebarToolbar({
  ...
  // translate() preserves FABRICA's pseudo-localization behavior. Without it the
