...
// Why: this animation tells the full FABRICA story end-to-end — the user opens a
...
// FABRICA's dropdown/popover primitives while staying inside the storyboard DOM.
