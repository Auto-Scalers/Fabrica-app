...
// Mac-style terminal traffic-light dots — the signature of an FABRICA terminal pane.
...
// Use FABRICA's browser: a browser pane with a cursor grabbing one highlighted
