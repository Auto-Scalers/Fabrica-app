    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="FABRICA"
          options={[
            { value: 'FABRICA', label: 'Fabrica worktrees only' },
      ...
      selectionSummary="Fabrica worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Fabrica worktrees only • Last 7 days')).toBeInTheDocument()
