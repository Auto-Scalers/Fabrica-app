...
export function humanizeTerminalError(error: string): string {
  ...
  return error.replace(
    ...
    translate(
      ...
      "Fabrica couldn't confirm whether this terminal's previous session is still running, so it left the session untouched. Reopen this pane to retry."
    )
  )
}
        ...
        <span style={{ minWidth: 0 }}>
          ...
          {showDaemonRestart ? (
            ...
            <>
              ...
              <a
                href="https://github.com/Auto-Scalers/Fabrica-app/issues"
