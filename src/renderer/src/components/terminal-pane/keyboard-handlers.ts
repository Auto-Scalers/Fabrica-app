...
export function resolveTerminalKeyboardShortcutAction(
  ...
  terminalShortcutPolicy: Parameters<typeof resolveTerminalShortcutAction>[11] = 'FABRICA-first',
...
export function matchFileSearchShortcut(
  ...
  terminalShortcutPolicy: TerminalShortcutPolicy = 'FABRICA-first'
): boolean {
  if (e.repeat) {
    return false
  }
 ...
 * so configurable FABRICA actions remain consistent across local and SSH panes.
 */
