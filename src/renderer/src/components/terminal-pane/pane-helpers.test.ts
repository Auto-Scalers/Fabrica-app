...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\FABRICA\\file.txt', 'windows')).toBe(
      'C:\\Users\\FABRICA\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\FABRICA\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\FABRICA\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\FABRICA\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\FABRICA\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.FABRICA/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.FABRICA/drops/my file'\\''s $draft.txt'"
    )
  })
})
