...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--fabrica-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--fabrica-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--fabrica-terminal-overlay-probe width)')
