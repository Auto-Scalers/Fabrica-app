// One-paste freeze report: `await window.__FABRICATerminalFreezeReport()` in the
...
type TerminalFreezeReportWindow = Window & {
  __FABRICATerminalFreezeReport?: () => Promise<TerminalFreezeReport>
}
...
export function installTerminalFreezeReport(): void {
  ...
  ;(window as TerminalFreezeReportWindow).__FABRICATerminalFreezeReport = buildTerminalFreezeReport
}
