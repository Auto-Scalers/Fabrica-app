...
const LINE_1 = 'Repo: https://github.com/Auto-Scalers/Fabrica-app/'
const LINE_2 = 'Description: 123'
const EXPECTED_URL = 'https://github.com/Auto-Scalers/Fabrica-app/'
const BUGGY_URL = 'https://github.com/Auto-Scalers/Fabrica-app/Description'
...
describe('#8832 hard-wrapped path candidates glue next-line text into URLs', () => {
  ...
  it('still builds a multi-row path candidate that concatenates Description onto the URL', () => {
    ...
    expect(glued!.text).toContain('https://github.com/Auto-Scalers/Fabrica-app/Description')
  })
  ...
  it.each([
    ...
    ['POSIX path', '/usr/local/bin/FABRICA'],
