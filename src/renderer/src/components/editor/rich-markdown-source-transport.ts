...
const TRANSPORT_PREFIX = '[[FABRICA_RICH_MD:'
const TRANSPORT_SUFFIX = ']]'
const KEY_PATTERN = /^[a-f0-9]{32}$/
const TRANSPORT_BODY_PATTERN =
  /^FABRICA_RICH_MD:[a-f0-9]{32}:(?:literal|inline-html|block-html|document-link|html-superscript-link):/
const LEGACY_PREFIXES = ['FABRICA_RAW_HTML_INLINE:', 'FABRICA_RAW_HTML_BLOCK:', 'FABRICA_DOC_LINK:'] as const
