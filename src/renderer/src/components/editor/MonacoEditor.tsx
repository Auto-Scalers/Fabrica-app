  ...
  return (
    ...
    >
      ...
      {selectionAnnotationTarget && shouldShowMarkdownAnnotations && !commentPopover ? (
        <button
          type="button"
          className="FABRICA-diff-comment-add-btn"
          style={{
            display: 'flex',
      ...
      <Editor
        ...
        language={language}
        // Why: defaultValue, not controlled value — FABRICA owns post-mount content sync; a controlled path would double setValue.
        ...
        path={filePath}
        // Why: FABRICA owns cursor/scroll restoration, so disable @monaco-editor/react's competing view-state Map.
        saveViewState={false}
        keepCurrentModel
      />
