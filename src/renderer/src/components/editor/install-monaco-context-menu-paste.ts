...
import {
  FABRICA_CONTEXT_MENU_PASTE_NAME,
  FABRICA_CONTEXT_MENU_PASTE_PRIORITY,
  runFABRICAContextMenuPaste
 ...
 * FABRICA's trusted IPC bridge instead of the sandbox-blocked navigator.clipboard.
