...
describe('rich Markdown HTML superscript links', () => {
  ...
  it('preserves authored current-key and legacy transport-looking text', () => {
    ...
    const authored = `${transport.create('inline-html', '<b>authored</b>')} [[FABRICA_RAW_HTML_INLINE:%3Ci%3Ex%3C%2Fi%3E]]`
  ...
  it('renders inert live DOM while exposing link semantics through Fabrica context', () => {
