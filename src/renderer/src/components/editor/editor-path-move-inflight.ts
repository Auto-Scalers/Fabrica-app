...
// Tracks FABRICA-owned moves in flight, for the rename + rekey duration only — no TTL, which would race a slow SSH rename.
...
/** True when this delete is the source side of a live FABRICA-owned move. */
