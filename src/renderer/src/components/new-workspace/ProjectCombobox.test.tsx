...
const projects: NewWorkspaceProjectOption[] = [
  ...
  {
    kind: 'project',
    id: 'github:Auto-Scalers/noqa',
    projectId: 'github:Auto-Scalers/noqa',
    displayName: 'noqa',
    badgeColor: '#222222',
    detail: 'Auto-Scalers/noqa'
  },
  {
    kind: 'project-group',
...
describe('ProjectCombobox', () => {
  it('renders a logical project label without host-specific SSH chrome', () => {
    ...
    expect(shell?.textContent).toContain('FABRICA')
  ...
  it('selects projects by logical project id', () => {
    ...
    openList()
    act(() => {
      rowFor('Auto-Scalers/noqa').dispatchEvent(new MouseEvent('click', { bubbles: true }))
    })

    expect(onValueChange).toHaveBeenCalledWith('github:Auto-Scalers/noqa')
  })
  ...
  it('filters as the user types, without a second search box', () => {
    ...
    type('noq')
    expect(container.textContent).toContain('Auto-Scalers/noqa')
    expect(container.textContent).not.toContain('Auto-Scalers/Fabrica-app')
  })
  ...
  it('commits the armed row on Enter', () => {
    ...
    expect(onValueChange).toHaveBeenCalledWith('github:Auto-Scalers/noqa')
    expect(onValueSelected).toHaveBeenCalledWith('github:Auto-Scalers/noqa')
  })
