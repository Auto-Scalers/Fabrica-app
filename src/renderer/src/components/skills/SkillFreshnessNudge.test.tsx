...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/FABRICA-cli',
    resolvedPath: '/home/.agents/skills/FABRICA-cli',
    physicalIdentity: 'physical-FABRICA-cli',
...
const DISMISSAL_KEY = ['physical-FABRICA-cli', 'FABRICA-cli', '2'].join('\0')
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          unresolvedPath: '/home/projects/work/.agents/skills/FABRICA-cli',
          resolvedPath: '/home/projects/work/.agents/skills/FABRICA-cli',
          physicalIdentity: 'physical-repo-FABRICA-cli'
        })
      ],
      eligibleUpdateNames: ['FABRICA-cli'],
      scanIssues: [],
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          physicalIdentity: 'physical-repo-FABRICA-cli-after-checkout'
        })
      ],
      eligibleUpdateNames: ['FABRICA-cli'],
      scanIssues: [],
