...
export function ensureBrowserPageWebview({
  ...
  webview.setAttribute('webpreferences', FABRICA_BROWSER_GUEST_WEB_PREFERENCES_ATTRIBUTE)
  ...
  // normal browser behavior instead of leaking FABRICA chrome through the guest.
