...
export const FABRICA_BROWSER_PAGE_ZOOM_EVENT = 'FABRICA:browser-page-zoom'
...
export function addBrowserPageZoomEventListener(
  ...
  window.addEventListener(FABRICA_BROWSER_PAGE_ZOOM_EVENT, listener)
  return () => window.removeEventListener(FABRICA_BROWSER_PAGE_ZOOM_EVENT, listener)
}
