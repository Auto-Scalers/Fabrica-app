...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Fabrica Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Fabrica Mobile')
  })

  it('labels the restore action explicitly when Fabrica Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
