...
const IOS_CHANNEL_COPY: Record<IosChannel, InstallCopy> = {
  stable: {
    ...
    url: 'https://apps.apple.com/app/FABRICA-ide/id6766130217'
  },
  preview: {
...
const ANDROID_COPY: InstallCopy = {
  ...
  url: 'https://github.com/Auto-Scalers/Fabrica-app/releases/download/mobile-android-v0.0.37/app-release.apk'
}
