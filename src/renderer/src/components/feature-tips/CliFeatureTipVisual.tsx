...
const CLI_AGENT_COMMANDS = [
  'FABRICA worktree create --name auth-pr-1',
  'FABRICA worktree create --name auth-pr-2',
  'FABRICA orchestration dispatch --task pr1 --to w1',
  'FABRICA orchestration dispatch --task pr2 --to w2'
]
