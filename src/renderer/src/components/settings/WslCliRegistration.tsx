...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'fabrica'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `fabrica` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Fabrica itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Fabrica will register {{value0}} so the command works from WSL terminals.',
