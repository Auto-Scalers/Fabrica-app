...
const FABRICA_IOS_APP_STORE_URL = 'https://apps.apple.com/app/FABRICA-ide/id6766130217'
const FABRICA_ANDROID_APK_URL =
  'https://github.com/Auto-Scalers/Fabrica-app/releases/download/mobile-android-v0.0.37/app-release.apk'
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Fabrica Mobile from the'
            )}{' '}
            <button
              type="button"
              onClick={() => void window.api.shell.openUrl(FABRICA_IOS_APP_STORE_URL)}
            ...
            <button
              ...
              onClick={() => void window.api.shell.openUrl(FABRICA_ANDROID_APK_URL)}
              className="cursor-pointer underline underline-offset-2 hover:text-foreground"
            >
              {translate(
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Fabrica Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Fabrica Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Fabrica Mobile shortcut in the sidebar.'
          )}
