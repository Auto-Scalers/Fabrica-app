...
export function getSystemNotificationSettingsCopy(
  ...
  if (platform === 'darwin') {
    return {
      ...
      failureDescription: 'Enable Allow notifications for Fabrica in System Settings.'
    }
  }
  ...
  if (platform === 'win32') {
    return {
      ...
      failureDescription: 'Enable notifications for Fabrica in Windows Settings.'
    }
  }
      ...
      toast.message(
        ...
        ),
        {
          description: translate(
            ...
            'If no macOS banner appeared, enable Allow notifications for Fabrica.'
          ),
          action: {
            label: translate(
      ...
      toast.error(
        ...
        ),
        {
          description: translate(
            ...
            'Check your desktop notification settings for Fabrica.'
          )
        }
      )
    }
