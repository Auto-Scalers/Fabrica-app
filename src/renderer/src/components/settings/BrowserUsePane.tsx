...
export function BrowserUseSetup({
  ...
  const browserUseInstallCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(FABRICA_CLI_SKILL_INSTALL_COMMAND, activeSkillRuntime.agentRuntime)
    : FABRICA_CLI_SKILL_INSTALL_COMMAND
  const browserUseUpdateCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(FABRICA_CLI_SKILL_UPDATE_COMMAND, activeSkillRuntime.agentRuntime)
    : FABRICA_CLI_SKILL_UPDATE_COMMAND
  ...
  const cliEnabled = isFABRICACliAvailableOnPath(cliStatus)
