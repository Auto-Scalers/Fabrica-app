...
export function ArtifactsSettingsPane({
  ...
  const howToSteps: HowToStep[] = [
      ...
      : [
          {
            ...
            description: isWebClient
              ? translate(
                  ...
                  'Open Settings → Artifacts in the Fabrica desktop app on the host device and enable publishing.'
                )
              : translate(
    ...
    {
      key: 'manage',
      title: translate('auto.components.settings.artifacts.manageStepTitle', 'Manage it in Fabrica'),
      description: translate(
          ...
          >
            {connecting
              ...
              : authStatus?.state === 'reconnect-required'
                ...
                : translate('auto.components.settings.artifacts.signIn', 'Sign in to Fabrica')}
          </Button>
        </section>
      ) : null}
