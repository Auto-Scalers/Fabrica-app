...
import { FABRICA_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Fabrica: browse issues, start linked workspaces, and let agents update tickets with /fabrica-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${FABRICA_LINEAR_SKILL_NAME}`}
      />
