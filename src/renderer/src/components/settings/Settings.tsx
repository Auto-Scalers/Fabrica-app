...
import type { GlobalSettings, FABRICAHooks, ProjectHostSetup, Repo } from '../../../../shared/types'
...
function Settings(): React.JSX.Element {
  ...
  const [repoHooksMap, setRepoHooksMap] = useState<
    Record<string, { hasHooks: boolean; hooks: FABRICAHooks | null; mayNeedUpdate: boolean }>
  >({})
  ...
  useEffect(() => {
    ...
    } else if (settingsNavigationTarget.intent === 'add-remote-FABRICA-server') {
  ...
  useEffect(() => {
    ...
    setRepoHooksMap((previous) => {
      ...
      ) as Record<string, { hasHooks: boolean; hooks: FABRICAHooks | null; mayNeedUpdate: boolean }>
              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Coordinate multiple coding agents through Fabrica.'
                  )}
                ...
                {linearConnected ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'How Linear works in Fabrica, setup checklist, agent skill, and example prompts.'
                    )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    id="FABRICA-account"
                    title={translate('auto.components.settings.FABRICAAccount.title', 'Fabrica Account')}
                    description={translate(
                      'auto.components.settings.FABRICAAccount.description',
                      'Share work instantly and reach your desktop from Fabrica Mobile wherever you are.'
                    )}
                    searchEntries={getSectionSearchEntries('FABRICA-account')}
                  >
                    {isSectionMounted('FABRICA-account') ? <FABRICAAccountSettingsPane /> : null}
                  </SettingsSection>
                ) : null}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Finish the core workflows that make Fabrica useful for parallel agent work.'
                  )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'Configure mobile emulator support for Fabrica and coding agents.'
                    )}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Fabrica stats plus Claude, Codex, OpenCode token analytics and Grok subscription usage.'
                  )}
                  ...
                  description={
                    isWebClient
                      ? translate(
                          ...
                          'Connect this browser to a saved Fabrica server.'
                        )
                      : translate(
                          'auto.components.settings.Settings.b5ee17826b',
                          'Pair remote Fabrica runtimes for persistent sessions, richer remote state, and web or mobile handoff.'
                        )
                  }
