...
describe('task source context summary', () => {
  it('shows provider, host, and provider identity for a single repo-backed source', () => {
    ...
    expect(summary.label).toBe('GitHub · devbox · Auto-Scalers/Fabrica-app')
    expect(summary.title).toBe('GitHub · Host: devbox · Source: Auto-Scalers/Fabrica-app')
  })
  ...
  it('shows repo-backed provider account labels when accounts can differ by host', () => {
    ...
    expect(summary.title).toBe(
      `GitHub · Host: ${LOCAL_HOST_LABEL}, builder · Account: personal-gh, work-gh · Source: Auto-Scalers/Fabrica-app · 2 selected projects`
    )
  })
  ...
  it('shows disconnected source-host availability for a single SSH repo source', () => {
    ...
    expect(summary.label).toBe('GitHub · devbox · disconnected · Auto-Scalers/Fabrica-app')
    expect(summary.title).toBe(
      'GitHub · Host: devbox · Availability: devbox disconnected · Source: Auto-Scalers/Fabrica-app'
    )
  })
  ...
  it('uses saved remote server labels in repo-backed source summaries and notices', () => {
    ...
    expect(
      ...
      label: 'GitHub · dev box · server update needed · Auto-Scalers/Fabrica-app',
      title:
        'GitHub · Host: dev box · Availability: dev box server update needed · Source: Auto-Scalers/Fabrica-app'
    })
  ...
  it('shows provider-specific source availability reasons', () => {
    expect(
      ...
      label: 'GitHub · devbox · provider auth needed · Auto-Scalers/Fabrica-app',
      title:
        'GitHub · Host: devbox · Availability: devbox provider auth needed · Source: Auto-Scalers/Fabrica-app'
    })
