...
describe('FileExplorerToolbar', () => {
  ...
  it('adds open-in launchers to the overflow menu', () => {
    ...
    expect(openInItems.props.worktreePath).toBe('/tmp/FABRICA')
...
describe('FileExplorerRow collapse folder action', () => {
  ...
  it('shows OS file copy for single local rows and SSH file rows on desktop', () => {
    const previous = (globalThis as { __FABRICA_WEB_CLIENT__?: boolean }).__FABRICA_WEB_CLIENT__
    try {
      ...
      ;(globalThis as { __FABRICA_WEB_CLIENT__?: boolean }).__FABRICA_WEB_CLIENT__ = previous
    }
  })
