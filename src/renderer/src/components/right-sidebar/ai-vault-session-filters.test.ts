...
describe('filterAiVaultSessions', () => {
    ...
    const sessions: AiVaultSession[] = [
      {
        ...baseSession,
        id: 'claude:old-path',
        cwd: '/Users/ada/workspaces/FABRICA/bream/src'
      },
      {
        ...baseSession,
  ...
  it('filters project scope by the resolved active project key', () => {
    ...
    const sessionProjectById = new Map([
      [projectSession.id, { kind: 'repo' as const, key: 'project:FABRICA', label: 'Fabrica' }],
    ...
    expect(
      filterAiVaultSessions([projectSession, otherSession], {
        ...
        sort: 'updated',
        activeWorktreePaths: [],
        activeProjectKey: 'project:FABRICA',
        sessionProjectById,
        hideEmptySessions: true
      }).map((session) => session.id)
...
describe('deriveAiVaultWorkspaceScopePaths', () => {
  it('includes current and same-repo prior filesystem paths', () => {
    expect(
      deriveAiVaultWorkspaceScopePaths({
        id: 'repo1::/Users/ada/workspaces/FABRICA/fix-agent-history',
        repoId: 'repo1',
  ...
  it('strips folder-workspace instance suffixes from prior ids', () => {
    expect(
      deriveAiVaultWorkspaceScopePaths({
        id: 'repo1::/Users/ada/folders/FABRICA',
        repoId: 'repo1',
        path: '/Users/ada/folders/FABRICA',
        priorWorktreeIds: [
          'repo1::/Users/ada/folders/old-FABRICA::workspace:123e4567-e89b-12d3-a456-426614174000'
        ]
      })
    ).toEqual(['/Users/ada/folders/FABRICA', '/Users/ada/folders/old-FABRICA'])
  })
      ...
      deriveAiVaultWorkspaceScopePaths(
        {
          ...
          path: '/Users/ada/workspaces/FABRICA/fix-agent-history',
          priorWorktreeIds: [
            'repo1::/Users/ada/workspaces/FABRICA/bream',
            'repo1::/Users/ada/workspaces/FABRICA/unclaimed-old-path'
          ]
        },
        [
          {
          ...
          {
            id: 'repo1::/Users/ada/workspaces/FABRICA/bream',
            repoId: 'repo1',
            path: '/Users/ada/workspaces/FABRICA/bream'
          }
        ]
      )
    ).toEqual([
      '/Users/ada/workspaces/FABRICA/fix-agent-history',
      '/Users/ada/workspaces/FABRICA/unclaimed-old-path'
    ])
  })
    ...
    expect(
      deriveAiVaultWorkspaceScopePaths(
        ...
        [
          ...
          {
            id: 'repo2::/Users/ada/workspaces/FABRICA/bream',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/FABRICA/bream'
          }
        ]
...
describe('deriveAiVaultScopeSessionPaths', () => {
    ...
    expect(
      deriveAiVaultScopeSessionPaths(
        ...
        [
          ...
          {
            id: 'repo1::/Users/ada/workspaces/FABRICA/sibling',
            repoId: 'repo1',
            path: '/Users/ada/workspaces/FABRICA/sibling'
          },
          {
      ...
      '/Users/ada/workspaces/FABRICA/fix-agent-history',
      '/Users/ada/workspaces/FABRICA/sibling'
    ])
  })
  ...
  it('adds active project setup paths across repos', () => {
    expect(
      deriveAiVaultScopeSessionPaths(
        {
          id: 'repo1::/Users/ada/workspaces/FABRICA/app',
          repoId: 'repo1',
          path: '/Users/ada/workspaces/FABRICA/app',
          priorWorktreeIds: []
        },
        [
          {
          ...
          {
            id: 'repo2::/Users/ada/workspaces/FABRICA/docs',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/FABRICA/docs'
          }
        ],
        {
          activeProjectKey: 'project:FABRICA',
    ...
    ).toEqual(['/Users/ada/workspaces/FABRICA/app', '/Users/ada/workspaces/FABRICA/docs'])
  })
  ...
  it('keeps live worktree paths when another setup shares the repo id', () => {
    expect(
      deriveAiVaultScopeSessionPaths(
        ...
        [
          {
            id: 'repo2::/Users/ada/workspaces/FABRICA/docs-worktree',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/FABRICA/docs-worktree'
          }
        ],
        {
          activeProjectKey: 'project:FABRICA',
      ...
      '/Users/ada/workspaces/FABRICA/app',
      '/Users/ada/workspaces/FABRICA/docs-worktree',
      '/Users/ada/workspaces/FABRICA/docs'
    ])
  })
})
  ...
  it('groups sibling worktree sessions by project label when resolved', () => {
    ...
    const sessionProjectById = new Map(
      sessions.map((session) => [
        session.id,
        { kind: 'repo' as const, key: 'project:FABRICA', label: 'Fabrica' }
      ])
    )
    const projectLabelByKey = new Map([['project:FABRICA', 'Canonical Fabrica']])
    ...
    ).toEqual([{ key: 'project:FABRICA', label: 'Canonical Fabrica', sessions }])
  })
