...
export function useDiffCommentDecorator({
  ...
  useEffect(() => {
    ...
    plus.type = 'button'
    plus.className = 'FABRICA-diff-comment-add-btn'
      ...
      rangeDecorationIds = editor.deltaDecorations(rangeDecorationIds, [
        {
          ...
          options: {
            isWholeLine: true,
            className: 'FABRICA-diff-comment-range-highlight'
          }
        }
      ])
    }
  ...
  useEffect(() => {
            ...
            headerActions={
              worktreeId && comment.author === undefined ? (
                <NotesSendMenu
                  ...
                  triggerClassName="FABRICA-diff-comment-edit"
    ...
    editor.changeViewZones((accessor) => {
      ...
      for (const c of relevant) {
        ...
        dom.className = 'FABRICA-diff-comment-inline'
