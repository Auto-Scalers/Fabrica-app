...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="FABRICA-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="FABRICA-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="FABRICA-diff-comment-popover-label">
          {title ??
