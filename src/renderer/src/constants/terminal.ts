...
export const TOGGLE_TERMINAL_PANE_EXPAND_EVENT = 'FABRICA-toggle-terminal-pane-expand'
export const FOCUS_TERMINAL_PANE_EVENT = 'FABRICA-focus-terminal-pane'
export const PASTE_TERMINAL_TEXT_EVENT = 'FABRICA-paste-terminal-text'
export const SPLIT_TERMINAL_PANE_EVENT = 'FABRICA-split-terminal-pane'
export const REQUEST_ACTIVE_TERMINAL_PANE_SPLIT_EVENT = 'FABRICA-request-active-terminal-pane-split'
export const CLOSE_TERMINAL_PANE_EVENT = 'FABRICA-close-terminal-pane'
export const BACKGROUND_MOUNT_TERMINAL_WORKTREE_EVENT = 'FABRICA-background-mount-terminal-worktree'
...
export const WAKE_HIBERNATED_AGENTS_WORKTREE_EVENT = 'FABRICA-wake-hibernated-agents-worktree'
...
export const SYNC_FIT_PANES_EVENT = 'FABRICA-sync-fit-panes'
