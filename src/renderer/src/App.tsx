...
function App(): React.JSX.Element {
  ...
  const actions = useAppStore(
    useShallow((s) => ({
      ...
      fetchFABRICAProfiles: s.fetchFABRICAProfiles,
  ...
  useEffect(() => {
    ...
    if (featureTipsDecision.tipId === 'FABRICA-cli') {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        void actions.fetchFABRICAProfiles()
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener(FABRICA_APP_RESTART_ABORTED_EVENT, shutdownCheckpoint.reset)
      window.removeEventListener(
        FABRICA_UPDATER_QUIT_AND_INSTALL_ABORTED_EVENT,
        shutdownCheckpoint.reset
      )
      window.removeEventListener(FABRICA_RENDERER_UNLOAD_PREVENTED_EVENT, shutdownCheckpoint.reset)
    }
  }, [])
              ...
              <ContextMenu>
                <ContextMenuTrigger asChild>
                  <div
                    ...
                    aria-label={translate('auto.App.5096cbbc86', 'Fabrica')}
                  >
                    <span className="titlebar-app-name-main">
                      {translate('auto.App.5096cbbc86', 'Fabrica')}
                    </span>
                  </div>
                </ContextMenuTrigger>
                <ContextMenuContent>
                        ...
                        <div className="flex flex-1 min-w-0 min-h-0 flex-col">
                          ...
                          <Suspense fallback={null}>
                            <RecoverableRenderErrorBoundary
                              ...
                              description={translate(
                                'auto.App.03a14f6b5b',
                                'Retry the page or navigate to another Fabrica surface.'
                              )}
                            >
