...
export type CodexPaneScanResult = {
  ...
  /** FABRICA launched Codex in this tab, so a shell foreground can still be reattach settle. */
 ...
 * Gated to FABRICA-launched Codex panes so an account switch never spends the
 ...
 * baked into their environment. Without this, quitting FABRICA before restarting a
