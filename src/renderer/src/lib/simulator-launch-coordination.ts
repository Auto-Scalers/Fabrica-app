...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'FABRICA:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'FABRICA:emulator-launch-failed'
