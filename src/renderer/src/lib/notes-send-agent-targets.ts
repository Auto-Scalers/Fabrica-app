 ...
 * PTY. TerminalTab.launchAgent records the harness FABRICA started; manually typed
...
function deriveTitleHintAgentTarget(
  ...
  if (!titleEvidence) {
    // Why: launchAgent is set the instant FABRICA spawns the tab, but the runtime
