...
describe('isWorkItemLookupText', () => {
  it('detects GitHub PR and issue URLs', () => {
    expect(isWorkItemLookupText('https://github.com/Auto-Scalers/Fabrica-app/pull/4900')).toBe(true)
    expect(isWorkItemLookupText('https://github.com/Auto-Scalers/Fabrica-app/issues/123')).toBe(true)
    expect(isWorkItemLookupText('  https://www.github.com/Auto-Scalers/Fabrica-app/pull/1 ')).toBe(true)
  })
