...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-FABRICA-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'FABRICA-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'FABRICA-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting FABRICA's pane drop layer handle it.
