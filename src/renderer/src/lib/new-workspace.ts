...
import type { FolderWorkspaceLinkedTask, FABRICAHooks } from '../../../shared/types'
...
// Why: when a repo has no `FABRICA.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: FABRICAHooks | null): string {
 ...
 * their `FABRICA.yaml` / `.fabrica/issue-command` yet.
 */
