 ...
 * process in the PTY tree, so an FABRICA "Codex" pane running a subagent reads as
 ...
 * recorded metadata (FABRICA started Codex in this tab), not a repaintable label,
