...
type ReferenceWidgetConstructor = {
  prototype: ReferenceWidgetInstance & {
    __FABRICAPeekPreviewOptionsInstalled?: true
  }
}

function applyPeekReferencesPreviewOptions(editor: PeekPreviewEditor | undefined): void {
  // Why: Monaco embedded editors inherit FABRICA's full-editor options first.
...
export function installMonacoPeekReferencesPreviewOptions(
  ...
  if (prototype.__FABRICAPeekPreviewOptionsInstalled) {
    return
  }
  ...
  prototype.__FABRICAPeekPreviewOptionsInstalled = true
}
