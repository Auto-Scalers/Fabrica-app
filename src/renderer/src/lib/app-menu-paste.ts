...
export const APP_MENU_PASTE_EVENT = 'FABRICA-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control FABRICA already resolved.
  ...
  // Why: for text controls FABRICA has already resolved ownership. Falling back
