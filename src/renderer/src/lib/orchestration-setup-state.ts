export const ORCHESTRATION_SETUP_STATE_EVENT = 'FABRICA:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'FABRICA.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'FABRICA.orchestration.setupDismissed'
