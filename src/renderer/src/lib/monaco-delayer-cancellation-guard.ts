...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __FABRICADelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__FABRICADelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__FABRICADelayerCancellationGuardInstalled = true
}
