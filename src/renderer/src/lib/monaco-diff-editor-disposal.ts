...
type GuardedDiffEditor = editor.IStandaloneDiffEditor & {
  __FABRICADiffEditorDisposeGuardInstalled?: true
}

type GuardedEditorNamespace = MonacoDiffEditorNamespace['editor'] & {
  __FABRICADiffEditorFactoryGuardInstalled?: true
}
...
export function guardMonacoDiffEditorDispose(
  ...
  if (guardedDiffEditor.__FABRICADiffEditorDisposeGuardInstalled) {
    return diffEditor
  }
  ...
  guardedDiffEditor.__FABRICADiffEditorDisposeGuardInstalled = true
...
export function installMonacoDiffEditorDisposalGuard(
  ...
  if (editorNamespace.__FABRICADiffEditorFactoryGuardInstalled) {
    return
  }
  ...
  editorNamespace.__FABRICADiffEditorFactoryGuardInstalled = true
}
