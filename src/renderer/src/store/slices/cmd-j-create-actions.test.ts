...
vi.mock('@/lib/web-client-location', () => ({
  isWebClientLocation: () =>
    Boolean((globalThis as { __FABRICA_WEB_CLIENT__?: boolean }).__FABRICA_WEB_CLIENT__)
}))

const pairedWebFlag = globalThis as { __FABRICA_WEB_CLIENT__?: boolean }
