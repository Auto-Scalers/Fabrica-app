...
export const FABRICAProfileFindProjectProfiles: Mock = vi.fn()
...
export function installReposRuntimeRoutingHarness(): void {
  beforeEach(() => {
    ...
    ptyKill.mockReset()
    FABRICAProfileFindProjectProfiles.mockReset()
    ...
    vi.stubGlobal('window', {
      api: {
        ...
        FABRICAProfiles: {
          findProjectProfiles: FABRICAProfileFindProjectProfiles
        },
        pty: { kill: ptyKill },
