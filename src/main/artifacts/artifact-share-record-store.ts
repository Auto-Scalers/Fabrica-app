...
import { getFABRICAProfileDirectory } from '../fabrica-profiles/profile-storage-paths'
...
function recordPath(profileId: string, userDataPath: string): string {
  return join(getFABRICAProfileDirectory(profileId, userDataPath), 'artifact-shares.json')
}
