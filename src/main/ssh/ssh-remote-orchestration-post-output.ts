...
import type {
  RemoteFABRICACliPostOutput,
  RemoteFABRICACliRequest
...
export async function acknowledgeRemoteFABRICACliPostOutput(
...
export function parseRemoteFABRICACliPostOutput(value: unknown): RemoteFABRICACliPostOutput {
...
): RemoteFABRICACliPostOutput | undefined {
