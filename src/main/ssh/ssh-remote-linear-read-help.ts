...
const LINEAR_HELP = `FABRICA linear

Usage: FABRICA linear <command> [options]
...
Run \`FABRICA linear <command> --help\` for command-specific usage.`

const LINEAR_ISSUE_HELP = `FABRICA linear issue

Usage: FABRICA linear issue [<id>] [--current] [--comments] [--children] [--depth <n>] [--attachments] [--relations] [--activity] [--full] [--workspace <id>] [--json]
...
Options:
  ...
  --pairing-code
  --environment
  --current              Use the current FABRICA worktree linked Linear issue
...
Examples:
  $ FABRICA linear search "auth bug"
  $ FABRICA linear search ENG --workspace all --json`

const LINEAR_TEAM_LIST_HELP = `FABRICA linear team list

Usage: FABRICA linear team list [--workspace <id>|all] [--json]

List connected Linear teams`

const LINEAR_TEAM_MEMBERS_HELP = `FABRICA linear team members

Usage: FABRICA linear team members --team <key|id> [--workspace <id>] [--json]

List Linear team members`

const LINEAR_TEAM_STATES_HELP = `FABRICA linear team states

Usage: FABRICA linear team states --team <key|id> [--workspace <id>] [--json]

List Linear team workflow states`

const LINEAR_TEAM_LABELS_HELP = `FABRICA linear team labels

Usage: FABRICA linear team labels --team <key|id> [--workspace <id>] [--json]

List Linear team labels`

const LINEAR_PROJECT_LIST_HELP = `FABRICA linear project list

Usage: FABRICA linear project list [--query <text>] [--limit <n>] [--workspace <id>|all] [--json]

List connected Linear projects`

const LINEAR_LIST_HELP = `FABRICA linear list

Usage: FABRICA linear list [--filter assigned|created|all|completed|open] [--team <key|id>] [--limit <n>] [--workspace <id>|all] [--json]
