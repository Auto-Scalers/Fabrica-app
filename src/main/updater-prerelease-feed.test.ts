  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/Auto-Scalers/Fabrica-app/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/Auto-Scalers/Fabrica-app/releases/download/v1.4.1/FABRICA-1.4.1-arm64-mac.zip'
      ])
    }
  )
