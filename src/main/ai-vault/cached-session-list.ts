...
// seam (the FABRICARuntimeService deps), NOT the window-only registerCoreHandlers
// path — `FABRICA serve` never runs that path, so sourcing it there would silently
