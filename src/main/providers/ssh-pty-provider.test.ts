...
describe('SshPtyProvider', () => {
  ...
  describe('spawn', () => {
    ...
    it('preserves explicit TERM and forwards final env deletions to the relay', async () => {
      ...
      const envToDelete = ['TERM_PROGRAM', 'FABRICA_ATTRIBUTION_SHIM_DIR']
      ...
      expect(spawnCall?.[1]?.env).not.toHaveProperty('FABRICA_ATTRIBUTION_SHIM_DIR')
    })
    ...
    it('injects the relay-backed FABRICA CLI bridge into remote PTY env', async () => {
      mux.request.mockResolvedValue({ id: 'pty-bridge' })
      provider = new SshPtyProvider('conn-1', mux as never, {
        binDir: '/home/user/.FABRICA-relay/bin',
        relayDir: '/home/user/.FABRICA-relay/relay-v1',
        nodePath: '/usr/bin/node',
        sockPath: '/home/user/.FABRICA-relay/relay.sock'
      })

      await provider.spawn({
        cols: 120,
        rows: 40,
        env: { PATH: '/usr/bin', FABRICA_TERMINAL_HANDLE: 'term_ssh' }
      })
      ...
      expectRequest(mux.request, 'pty.spawn', {
        ...
        cwd: undefined,
        env: {
          PATH: '/home/user/.FABRICA-relay/bin:/usr/bin',
          FABRICA_TERMINAL_HANDLE: 'term_ssh',
          [POWERLEVEL10K_WIZARD_DISABLE_ENV]: 'true',
          FABRICA_REMOTE_CLI_BIN_DIR: '/home/user/.FABRICA-relay/bin',
          FABRICA_RELAY_DIR: '/home/user/.FABRICA-relay/relay-v1',
          FABRICA_RELAY_NODE_PATH: '/usr/bin/node',
          FABRICA_RELAY_SOCKET_PATH: '/home/user/.FABRICA-relay/relay.sock'
        }
      })
    })
    ...
    it('uses Windows PATH delimiters for native Windows SSH bridge env', async () => {
      mux.request.mockResolvedValue({ id: 'pty-bridge' })
      provider = new SshPtyProvider('conn-1', mux as never, {
        binDir: 'C:/Users/me/.FABRICA-relay/bin',
        relayDir: 'C:/Users/me/.FABRICA-remote/relay-v1',
      ...
      expectRequest(mux.request, 'pty.spawn', {
        ...
        cwd: undefined,
        env: {
          Path: 'C:/Users/me/.FABRICA-relay/bin;C:/Windows/System32;C:/Tools',
          [POWERLEVEL10K_WIZARD_DISABLE_ENV]: 'true',
          FABRICA_REMOTE_CLI_BIN_DIR: 'C:/Users/me/.FABRICA-relay/bin',
          FABRICA_RELAY_DIR: 'C:/Users/me/.FABRICA-remote/relay-v1',
          FABRICA_RELAY_NODE_PATH: 'C:/Program Files/nodejs/node.exe',
          FABRICA_RELAY_SOCKET_PATH: '\\\\.\\pipe\\FABRICA-relay-123'
        }
      })
    })
