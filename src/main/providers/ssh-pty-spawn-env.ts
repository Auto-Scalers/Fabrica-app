...
export function buildSshPtySpawnEnv(args: {
  ...
  if (args.remoteCliBridgeEnv) {
    ...
    merged.FABRICA_REMOTE_CLI_BIN_DIR = args.remoteCliBridgeEnv.binDir
    merged.FABRICA_RELAY_DIR = args.remoteCliBridgeEnv.relayDir
    merged.FABRICA_RELAY_NODE_PATH = args.remoteCliBridgeEnv.nodePath
    merged.FABRICA_RELAY_SOCKET_PATH = args.remoteCliBridgeEnv.sockPath
    if (args.remoteCliBridgeEnv.credentialFile) {
      merged.FABRICA_RELAY_CREDENTIAL_FILE = args.remoteCliBridgeEnv.credentialFile
    }
  }
