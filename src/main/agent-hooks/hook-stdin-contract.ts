...
export const WINDOWS_HOOK_STDIN_DRAIN_LABEL = 'FABRICA_agent_hook_drain_stdin'
...
// Why (#11549): missing FABRICA context means the hook ran outside an FABRICA pane, where the caller
