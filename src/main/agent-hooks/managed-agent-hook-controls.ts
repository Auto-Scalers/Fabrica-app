...
// FABRICA's script, but the presence gate below then skips install() forever, freezing the
// script at whatever FABRICA generated last. Existing scripts are FABRICA-owned, so bring them
