...
type BrowserClickedLinkRoutingGlobal = typeof globalThis & {
  __FABRICABrowserClickedLinkRouting?: BrowserClickedLinkRoutingState
}
...
export function installBrowserClickedLinkRouting(
  ...
  const existing = routingGlobal.__FABRICABrowserClickedLinkRouting
  if (existing) {
  ...
  state.listener = (event) => {
    ...
    // opener-dependent window flows in FABRICA's guarded popup window.
  ...
  routingGlobal.__FABRICABrowserClickedLinkRouting = state
