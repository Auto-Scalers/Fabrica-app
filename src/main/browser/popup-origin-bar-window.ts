...
/**
 * Hosts a guest-opened popup inside an FABRICA-built window whose top strip is a
 * separate, FABRICA-controlled WebContentsView showing the popup's current
...
export function openPopupWithOriginBar(
  ...
  // Why: the origin bar renders only FABRICA's own data: URL and must stay
