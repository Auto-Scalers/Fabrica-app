...
export const E2E_FORCE_DAEMON_HEALTH_UNREACHABLE_ENV = 'FABRICA_E2E_FORCE_DAEMON_HEALTH_UNREACHABLE'
...
// zero extra process launches. Timed under FABRICA_STARTUP_DIAGNOSTICS so the
...
// Accessibility/Automation grants on FABRICA silently stop covering its terminals (STA-3491).
