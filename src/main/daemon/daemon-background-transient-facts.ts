...
// daemon-side fact authority): FABRICA_DAEMON_BACKGROUND_STREAM_DROP=0.
export const BACKGROUND_STREAM_DROP_ENABLED = process.env.FABRICA_DAEMON_BACKGROUND_STREAM_DROP !== '0'
