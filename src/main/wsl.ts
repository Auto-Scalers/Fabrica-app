...
const WSL_DIRECTORY_EXISTS_MARKER = '__FABRICA_DIRECTORY_EXISTS__'
const WSL_DIRECTORY_MISSING_MARKER = '__FABRICA_DIRECTORY_MISSING__'
 ...
 * breaks scripts that read FABRICA_ROOT_PATH or similar env vars inside WSL.
 */
...
// null instead fails open and silently spawns `wsl.exe -d <distro>` for a distro FABRICA
 ...
 *
 * Why: worktrees for WSL repos are created under ~/FABRICA/workspaces inside
