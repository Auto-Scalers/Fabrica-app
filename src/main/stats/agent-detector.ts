 ...
 * FABRICA-runtime.ts normalizeTerminalChunk but avoids importing the runtime.
 */
...
export class AgentDetector {
  ...
  /**
   * Called on every PTY data chunk (from FABRICA-runtime.ts onPtyData).
  ...
  /**
   * Called when a PTY process exits (from FABRICA-runtime.ts onPtyExit).
   */
