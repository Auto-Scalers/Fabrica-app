...
import type { FABRICARuntimeRpcServer } from '../runtime/runtime-rpc'
...
// FABRICARuntimeRpcServer because it owns the device registry and TLS state.
...
export function registerMobileHandlers(
  rpcServer: FABRICARuntimeRpcServer,
