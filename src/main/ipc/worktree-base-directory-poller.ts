...
export function createWorktreePollerWindowVisibility(
  ...
  // that has NEVER been shown is either headless (FABRICA_E2E_HEADLESS keeps a live but
...
// churn to FABRICA just to observe a handful of shallow paths. The replacements
...
// FABRICA's own worktree operations notify the renderer directly.
