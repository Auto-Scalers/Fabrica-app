...
describe('SSH import remote path safety', () => {
  ...
  const destDir = 'C:/Users/me/project/.FABRICA/drops'
  ...
  it.runIf(process.platform !== 'win32')(
    ...
    async () => {
      const sourcePath = '/tmp/..\\..\\.ssh\\FABRICA_drop'
  ...
  it.each(['report.txt:FABRICA', 'NUL', 'trailing.', 'question?.txt'])(
