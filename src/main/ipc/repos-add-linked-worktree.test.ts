...
const MAIN_CHECKOUT = '/Users/dev/projects/FABRICA'
const LINKED_WORKTREE = '/Users/dev/FABRICA/workspaces/FABRICA/pr-3235'
...
describe('repos:add with git worktrees', () => {
  ...
  it('matches the tracked main checkout across path separator differences', async () => {
    mockStore.getRepos.mockReturnValue([
      { ...trackedMainRepo(), path: 'C:\\Users\\dev\\projects\\FABRICA' } as Repo
    ])
    getLinkedWorktreeMainRepoRootMock.mockReturnValue('C:/Users/dev/projects/FABRICA')
