...
function shouldSkipFresh(
  ...
  return Date.now() - candidate.cachedFetchedAt < refreshIntervalFFABRICAndidate(candidate)
}
...
function freshRetryAt(candidate: GitHubPRRefreshCandidate): number | null {
  return candidate.cachedFetchedAt == null
    ? null
    : candidate.cachedFetchedAt + refreshIntervalFFABRICAndidate(candidate)
}
...
function refreshIntervalFFABRICAndidate(candidate: GitHubPRRefreshCandidate): number {
