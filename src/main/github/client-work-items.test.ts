...
describe('listWorkItems', () => {
  ...
  it('marks fork PRs as cross-repository when REST payload only includes head.label', async () => {
    getIssueOwnerRepoMock.mockResolvedValueOnce({ owner: 'Auto-Scalers', repo: 'fabrica' })
    getOwnerRepoMock.mockResolvedValueOnce({ owner: 'Auto-Scalers', repo: 'fabrica' })
      ...
      stdout: JSON.stringify([
        {
          ...
          state: 'open',
          html_url: 'https://github.com/Auto-Scalers/Fabrica-app/pull/1849',
    ...
    expect(items).toEqual([
      {
        ...
        title: 'Fork PR with missing head repo',
        state: 'open',
        url: 'https://github.com/Auto-Scalers/Fabrica-app/pull/1849',
        labels: [],
        updatedAt: '2026-04-01T00:00:00Z',
        author: 'contributor',
        ...
        baseRefName: 'main',
        headSha: 'head-1849',
        prRepo: { owner: 'Auto-Scalers', repo: 'fabrica' },
