...
const PLUGIN_KEY = 'fabrica-samples.demo'
const WORKTREE_ID = 'repo-id::/Users/private/FABRICA'
...
function createServices(): PluginHostServices {
  return {
    resolveActiveWorktreeContext: vi.fn().mockResolvedValue({
      ...
      branch: 'main',
      displayName: 'FABRICA',
      path: '/Users/private/FABRICA'
    }),
    listWorktreeTerminals: vi
      .fn()
      .mockResolvedValue([{ id: TERMINAL_ID, title: '/home/private/FABRICA' }]),
