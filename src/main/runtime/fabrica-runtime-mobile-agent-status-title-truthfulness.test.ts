...
async function createRuntime(rows: AgentStatusIpcPayload[] = []): Promise<FABRICARuntimeService> {
...
function publishRendererWorkingPane(runtime: FABRICARuntimeService, paneTitle: string): void {
