...
describe('resolveAdvertisedPairingEndpoint', () => {
  ...
  it.each([
    ...
    ['http://proxy.example.test/FABRICA', 'ws://proxy.example.test/FABRICA'],
    ['https://proxy.example.test/FABRICA', 'wss://proxy.example.test/FABRICA'],
    [
      'wss://proxy.example.test:8443/FABRICA?route=runtime',
      'wss://proxy.example.test:8443/FABRICA?route=runtime'
    ]
...
describe('resolveAdvertisedPairingHostname', () => {
  ...
  it.each([
    ...
    ['desktop', 'desktop'],
    ['wss://proxy.example.test:8443/FABRICA', 'proxy.example.test']
