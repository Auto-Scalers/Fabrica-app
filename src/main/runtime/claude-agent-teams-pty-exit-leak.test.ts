 ...
 * called solely from `FABRICARuntimeService.closeTerminal` (the explicit user-close IPC).
...
function registerTeam(runtime: FABRICARuntimeService, ptyId: string, leaderHandle: string): void {
