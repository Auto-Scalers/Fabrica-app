...
function syncSshSplit(runtime: FABRICARuntimeService, snapshot: RuntimeMobileSessionTabsSnapshot) {
...
describe('FABRICARuntimeService terminal retirement host partitioning (STA-3463)', () => {
  it('retires an exited SSH pane from the SSH partition and leaves the local partition untouched', async () => {
    ...
    const runtime = new FABRICARuntimeService(harness.store)
