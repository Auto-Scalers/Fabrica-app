...
const WORKTREE_PATH = '/Users/dev/FABRICA/workspaces/FABRICA/perf-terminal-list-diet'
...
const titleFor = (index: number): string => `claude — FABRICA/perf-terminal-list-diet #${index}`
...
function buildLoadedRuntime(): FABRICARuntimeService {
