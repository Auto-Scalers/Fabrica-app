...
import type { MobilePairingConnectionContext, FABRICARuntimeRpcServer } from '../runtime-rpc'
import type {
...
type DesktopRelayServiceOptions = {
  ...
  userDataPath: string
  appVersion: string
  runtimeRpc: FABRICARuntimeRpcServer
...
export class DesktopRelayService {
  ...
  private readonly runtimeRpc: FABRICARuntimeRpcServer
