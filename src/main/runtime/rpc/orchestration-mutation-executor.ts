...
export class OrchestrationMutationExecutor {
  ...
  constructor(private readonly runtime: FABRICARuntimeService) {}
        ...
        throw new OrchestrationError(
          ...
          recovery
            ? {
                ...
                recoveryCommand: `FABRICA orchestration worker-show --dispatch ${recovery.dispatchId} --json`
              }
            : { requestId }
        )
      }
...
const executorsByRuntime = new WeakMap<FABRICARuntimeService, OrchestrationMutationExecutor>()
