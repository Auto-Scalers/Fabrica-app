...
export type LegacyCheckParams = {
  ...
  compatibilityCliCommand?: 'fabrica' | 'FABRICA' | 'FABRICA-ide' | 'FABRICA-dev'
}
...
export type LegacyAskParams = {
  ...
  timeoutMs?: number
  compatibilityCliCommand?: 'fabrica' | 'FABRICA' | 'FABRICA-ide' | 'FABRICA-dev'
  compatibilityWindowsCommand?: 'fabrica' | 'FABRICA' | 'FABRICA-ide'
}
...
export function supportedLegacyHints(
  ...
  cliCommand: 'fabrica' | 'FABRICA' | 'FABRICA-ide' | 'FABRICA-dev'
): string[] {
  if (
