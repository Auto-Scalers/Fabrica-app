...
const federationAckStates = new WeakMap<FABRICARuntimeService, FederationAckRuntimeState>()

export function clearFederationAckCheckpoints(runtime: FABRICARuntimeService): void {
