...
const pidFile = process.env.FABRICA_DEV_WRAPPER_TEST_PID_FILE
const envFile = process.env.FABRICA_DEV_WRAPPER_TEST_ENV_FILE
...
if (!pidFile) {
  throw new Error('FABRICA_DEV_WRAPPER_TEST_PID_FILE is required')
}
    ...
    JSON.stringify(
      {
        ...
        label: process.env.FABRICA_DEV_INSTANCE_LABEL ?? null,
        branch: process.env.FABRICA_DEV_BRANCH ?? null,
        worktreeName: process.env.FABRICA_DEV_WORKTREE_NAME ?? null,
        repoRoot: process.env.FABRICA_DEV_REPO_ROOT ?? null,
        badgeLabel: process.env.FABRICA_DEV_DOCK_BADGE_LABEL ?? null,
        dockTitle: process.env.FABRICA_DEV_DOCK_TITLE ?? null,
        stableName: process.env.FABRICA_DEV_STABLE_NAME ?? null,
