...
// No-op in contributor / non-official builds; only official stable/rc builds (CI-injected `FABRICA_BUILD_IDENTITY` + `FABRICA_POSTHOG_WRITE_KEY`) transmit.
