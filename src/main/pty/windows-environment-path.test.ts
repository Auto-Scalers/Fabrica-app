...
describe('mergePersistedWindowsPath', () => {
  it('expands variables already present in the inherited PATH', () => {
    ...
    expect(env.Path).toBe('C:\\Users\\FABRICA\\AppData\\Local\\agy\\bin;C:\\Windows')
  })
  ...
  it('appends missing persisted segments without reordering the inherited PATH', () => {
    const execFileSync = vi
      ...
      .mockReturnValueOnce(
        [
          ...
          '    Path    REG_EXPAND_SZ    C:\\Users\\me\\AppData\\Local\\FABRICA\\bin;C:\\Existing',
          ''
        ].join('\r\n')
      )
    ...
    expect(env.Path).toBe(
      'C:\\Existing;C:\\Windows\\System32;C:\\Users\\me\\AppData\\Local\\FABRICA\\bin'
    )
  })
