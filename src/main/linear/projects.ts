...
const FABRICA_PROJECT_DETAIL_FIELDS = `
  ${FABRICA_PROJECT_FIELDS}
...
const PROJECTS_QUERY = `
  query FABRICALinearProjects($first: Int, $filter: ProjectFilter, $orderBy: PaginationOrderBy) {
...
const SEARCH_PROJECTS_QUERY = `
  query FABRICALinearProjectSearch($term: String!, $first: Int, $after: String) {
...
const PROJECT_QUERY = `
  query FABRICALinearProject($id: String!) {
    project(id: $id) {
      ${FABRICA_PROJECT_DETAIL_FIELDS}
    }
  }
`

const CREATE_PROJECT_MUTATION = `
  mutation FABRICALinearProjectCreate($input: ProjectCreateInput!) {
...
const PROJECT_ISSUES_QUERY = `
  query FABRICALinearProjectIssues(
    $id: String!,
    $first: Int,
    $after: String,
...
const PROJECT_TEAMS_QUERY = `
  query FABRICALinearProjectTeams($id: String!, $first: Int, $after: String) {
    project(id: $id) {
...
const CUSTOM_VIEWS_QUERY = `
  query FABRICALinearCustomViews(
    $first: Int,
...
const CUSTOM_VIEW_QUERY = `
  query FABRICALinearCustomView($id: String!) {
    customView(id: $id) {
      id
      name
      description
...
const CUSTOM_VIEW_ISSUES_QUERY = `
  query FABRICALinearCustomViewIssues(
    $id: String!,
    $first: Int,
    $after: String,
    $orderBy: PaginationOrderBy
...
const CUSTOM_VIEW_PROJECTS_QUERY = `
  query FABRICALinearCustomViewProjects($id: String!, $first: Int, $orderBy: PaginationOrderBy) {
    customView(id: $id) {
      id
      modelName
...
async function readIssueConnectionPages(
  ...
  while (items.length < limit) {
    ...
    // FABRICA reads must follow cursors to show more than one backend page.
