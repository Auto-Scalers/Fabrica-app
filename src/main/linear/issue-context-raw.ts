...
export const ISSUE_QUERY = `
  query FABRICAAgentLinearIssue($id: String!) {
    issue(id: $id) {
      ${ISSUE_FIELDS}
    }
  }
...
export const SEARCH_QUERY = `
  query FABRICAAgentLinearSearch($term: String!, $first: Int) {
...
export const COMMENTS_QUERY = `
  query FABRICAAgentLinearIssueComments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const CHILDREN_QUERY = `
  query FABRICAAgentLinearIssueChildren($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const ATTACHMENTS_QUERY = `
  query FABRICAAgentLinearIssueAttachments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const RELATIONS_QUERY = `
  query FABRICAAgentLinearIssueRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const INVERSE_RELATIONS_QUERY = `
  query FABRICAAgentLinearIssueInverseRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
