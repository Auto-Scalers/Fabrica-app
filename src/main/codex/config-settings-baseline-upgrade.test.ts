...
beforeEach(() => {
  tmpHome = mkdtempSync(join(tmpdir(), 'FABRICA-codex-settings-upgrade-home-'))
  userDataDir = mkdtempSync(join(tmpdir(), 'FABRICA-codex-settings-upgrade-data-'))
...
function baselinePath(): string {
  return join(runtimeHomePath(), '.FABRICA-config-settings-baseline.json')
}
