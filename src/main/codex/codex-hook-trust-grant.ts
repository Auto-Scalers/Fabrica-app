...
const DISABLE_ENV_FLAG = 'FABRICA_DISABLE_CODEX_TRUST_RPC'
...
export type CodexManagedTrustGrantPlan = {
  ...
  /** Managed trust identities FABRICA just wrote (no trustedHash). */
...
/**
 * Grants trust for FABRICA's managed Codex hooks through codex's own app-server
