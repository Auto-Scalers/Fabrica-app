...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'FABRICA-amp-home-'))
  ...
  it('installs an FABRICA-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.FABRICA_PANE_KEY')
  ...
  it('removes only FABRICA-managed Amp plugin files', () => {
