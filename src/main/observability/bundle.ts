...
// user-initiated network path from the error-tracking lane to FABRICA infra. The per-bundle
...
export type CollectBundleOptions = {
  ...
  readonly FABRICAChannel: 'stable' | 'rc' | 'dev'
}
...
type BundleHeader = {
  ...
  readonly FABRICA_channel: 'stable' | 'rc' | 'dev'
...
export function collectBundle(opts: CollectBundleOptions): CollectedBundle {
  ...
  const header: BundleHeader = {
    ...
    FABRICA_channel: opts.FABRICAChannel,
