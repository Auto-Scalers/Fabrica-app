...
const ATOM_FEED_URL = 'https://github.com/Auto-Scalers/Fabrica-app/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/Auto-Scalers/Fabrica-app/releases/download'
