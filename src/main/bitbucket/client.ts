...
function getAuthConfig(): BitbucketAuthConfig {
  return {
    baseUrl: envValue('FABRICA_BITBUCKET_API_BASE_URL') ?? DEFAULT_API_BASE_URL,
    accessToken: envValue('FABRICA_BITBUCKET_ACCESS_TOKEN'),
    email: envValue('FABRICA_BITBUCKET_EMAIL'),
    apiToken: envValue('FABRICA_BITBUCKET_API_TOKEN')
  }
}
