...
export type HostedReviewExecutionOptions = {
  ...
  /** Paths FABRICA may have symlinked into this worktree. An untracked entry that
   *  is one of these is FABRICA's own artifact, not work the user can commit, so it
