 ...
 * and `FABRICA serve` alike, and each one used to reach the provider directly. The
...
/**
 * Drops every cached answer for a repo. Called when FABRICA itself opens a review,
