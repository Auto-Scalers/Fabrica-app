      ...
      [
        {
          ...
          summary: 'Permissions',
          usage: 'FABRICA emulator permissions <op> <package> [permission]',
  ...
  const specs: CommandSpec[] = [
    {
      ...
      usage: 'FABRICA worktree rm --worktree <selector>',
      allowedFlags: ['worktree', 'force']
    },
    {
      path: ['repo', 'show'],
      summary: 'Show a repo',
      usage: 'FABRICA repo show --repo <selector>',
      allowedFlags: ['repo'],
      positionalArgs: ['repo']
    }
  ]
