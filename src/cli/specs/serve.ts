...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    examples: [
      'fabrica serve',
      'fabrica serve --json',
      'fabrica serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'fabrica serve --port 6768 --pairing-address 100.64.1.20',
      'fabrica serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
