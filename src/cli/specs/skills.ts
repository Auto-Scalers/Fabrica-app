...
export const SKILL_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: ['fabrica skills get FABRICA-cli', 'fabrica skills get orchestration --full']
  },
  {
    path: ['skills', 'install'],
    ...
    examples: [
      ...
      'fabrica skills install --skill FABRICA-cli --skill orchestration',
  ...
  },
  {
    ...
    examples: [
      ...
      'fabrica skills update --skill FABRICA-cli --skill orchestration',
