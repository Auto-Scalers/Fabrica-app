...
export const PROJECT_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage: 'fabrica project setups [--project <id>] [--host <host-id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'project', 'host'],
    notes: ['A setup means a project is available on a host at a concrete filesystem path.'],
    examples: [
      'fabrica project setups',
      'fabrica project setups --project github:Auto-Scalers/Fabrica-app',
      'fabrica project setups --host local'
    ]
  },
  {
  ...
  },
  {
    ...
    examples: [
      'fabrica project setup-clone --project github:Auto-Scalers/Fabrica-app --host local --url https://github.com/Auto-Scalers/Fabrica-app.git --destination ~/src',
      'fabrica project setup-clone --project github:Auto-Scalers/Fabrica-app --host runtime:gpu --url https://github.com/Auto-Scalers/Fabrica-app.git --destination /srv --json'
    ]
  },
  {
  ...
  },
  {
    ...
    usage: 'fabrica project setup-delete --setup <setup-id> [--json]',
    ...
    examples: ['fabrica project setup-delete --setup github:Auto-Scalers/Fabrica::gpu --json']
  }
]
