...
import { launchFABRICAApp } from './launch'
...
export class RuntimeClient {
  ...
  constructor(
    ...
    remotePairingCode = process.env.FABRICA_PAIRING_CODE ?? process.env.FABRICA_REMOTE_PAIRING ?? null,
    ...
    if (this.remotePairing) {
      ...
      return {
        ...
        result: {
          ...
          // that this client machine has a local FABRICA desktop process.
          app: {
            running: false,
            pid: null,
  ...
  async openFABRICA(timeoutMs = 15_000): Promise<RuntimeRpcSuccess<CliStatusResult>> {
