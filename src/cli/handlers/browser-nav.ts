...
// round-trip, even when FABRICA is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "FABRICA is not running" by the
