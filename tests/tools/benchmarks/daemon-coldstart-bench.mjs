#!/usr/bin/env node
/**
 * Fabrica daemon cold-start benchmark (Windows-focused).
 *
 ...
 *     [--exe <path-to-packaged-Fabrica.exe>]
 *
...
async function main() {
  ...
  const fixtureDir = resolve(join(os.tmpdir(), 'fabrica-daemon-bench', 'userdata'))
