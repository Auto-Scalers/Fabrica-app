...
//
// GitHub #7742: when Fabrica's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Fabrica on the same box is never touched.
 */
