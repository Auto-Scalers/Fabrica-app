...
/**
 * Launch the installed Fabrica.exe. Pointing userDataDir at a harness-owned temp
...
export async function launchInstalledApp({
  ...
  const app = await electron.launch({
    ...
    env: {
      ...cleanEnv,
      // Packaged main honors FABRICA_E2E_USER_DATA_DIR to relocate userData
...
const CLI_FEATURE_TIP_TITLE = 'Let agents drive Fabrica with the Fabrica CLI'
