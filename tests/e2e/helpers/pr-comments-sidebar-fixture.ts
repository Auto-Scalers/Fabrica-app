...
export const FIXTURE_COMMENTS: PRComment[] = [
  {
    ...
    url: 'https://github.com/acme/FABRICA/pull/73#discussion_r101',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/FABRICA/pull/73#issuecomment-102',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/FABRICA/pull/73#discussion_r103',
...
export async function seedPRCommentsSidebarFixture(page: Page): Promise<PRCommentsSidebarSeed> {
  return page.evaluate(async (fixtureComments: PRComment[]) => {
    ...
    const pr: PRInfo = {
      ...
      state: 'open',
      url: `https://github.com/acme/FABRICA/pull/${prNumber}`,
    ...
    window.localStorage.setItem('FABRICA:pr-comment-presentation', 'cards')
