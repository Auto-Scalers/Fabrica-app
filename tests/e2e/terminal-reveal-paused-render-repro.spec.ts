...
test.describe('terminal reveal paused-render recovery', () => {
  test("reveal repaint forces a render through xterm's paused gate", async ({ fabricaPage }) => {
    // Why: __store / __paneManagers live on the main FABRICA renderer window
    // (fabricaPage), not Playwright's default first page.
    const page = fabricaPage
