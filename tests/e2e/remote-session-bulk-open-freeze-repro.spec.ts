 ...
 *
 * Topology under test:
 *   R1: headless Remote FABRICA host + paired desktop web client (paired-remote-server)
 *
 * Measurement:
...
const USE_DESKTOP_PAIR = process.env.FABRICA_E2E_FREEZE_DESKTOP_PAIR === '1'
