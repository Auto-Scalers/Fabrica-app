...
export const REMOTE_TUI_DONE = 'FABRICA_REMOTE_CODEX_ARTIFACT_TUI_DONE'
...
const REMOTE_CODEX_FIXTURE_FRAMES = parseEnvNumber(process.env.FABRICA_E2E_CODEX_FIXTURE_FRAMES, 34)
const REMOTE_CODEX_FIXTURE_FRAME_DELAY_MS = parseEnvNumber(
  process.env.FABRICA_E2E_CODEX_FIXTURE_FRAME_DELAY_MS,
  45
)
...
await write('If FABRICA leaves wide gray rectangles here, they are stale remote-PTY render artifacts.\\r\\n')
...
const marker = process.argv.join(' ').match(/FABRICA_REMOTE_CODEX_ARTIFACT_TUI_DONE|FABRICA_REAL_REMOTE_CODEX_DONE_[0-9]+/)?.[0] || '${REMOTE_TUI_DONE}'
const scrollTop = 1
...
await write('Tip: deterministic fixture for FABRICA SSH Codex display artifacts.\\r\\n\\r\\n')
