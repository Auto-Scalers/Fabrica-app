...
const relativeFilePath =
  'packages/FABRICA/src/renderer/src/components/navigation/worktree/quick-open/long-path-fixtures/very-deeply-nested-folder/QuickOpenTarget.tsx'
...
test('cmd+p quick open prioritizes the filename and reveals the full path on hover', async ({
  ...
  const dialog = fabricaPage.getByRole('dialog', { name: 'Go to file' })
  ...
  const proofPath = process.env.FABRICA_QUICK_OPEN_PROOF_PATH
  if (proofPath) {
