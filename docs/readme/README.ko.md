...
<p align="center">
  <a href="https://github.com/Auto-Scalers/Fabrica-app"><img src="https://img.shields.io/github/stars/Auto-Scalers/Fabrica-app?style=flat&amp;label=%E2%98%85&amp;color=08C" alt="GitHub 스타" /></a>
  <a href="https://github.com/Auto-Scalers/Fabrica-app/releases"><img src="../assets/readme-downloads.svg" alt="전체 릴리스 누적 다운로드 수" /></a>
  <img src="https://img.shields.io/badge/license-MIT-08C?style=flat" alt="라이선스: MIT" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Fabrica Discord 참여" /></a>
  <a href="https://x.com/fabrica_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="X에서 Fabrica 팔로우" /></a>
...
<h3 align="center"><a href="https://fabrica-ai.vercel.app/download"><ins>Fabrica 다운로드</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="병렬 worktree에서 에이전트를 실행 중인 Fabrica 데스크톱 앱과 한쪽 모서리에 보이는 Fabrica 모바일 companion 앱" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/fabrica-ide/id6766130217) · [Android APK](https://github.com/Auto-Scalers/Fabrica-app/releases/download/mobile-android-v0.0.37/app-release.apk) · [문서 →](https://fabrica-ai.vercel.app/docs/mobile)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Fabrica 데스크톱과 모바일 companion 앱" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[문서 →](https://fabrica-ai.vercel.app/docs/model/worktrees)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/model/worktrees"><picture><source srcset="../assets/feature-wall/parallel-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/parallel-worktrees.jpg" alt="병렬 worktree 오케스트레이션" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[문서 →](https://fabrica-ai.vercel.app/docs/terminal)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/terminal"><picture><source srcset="../assets/feature-wall/terminal-splits.gif" type="image/gif"><img src="../assets/feature-wall/terminal-splits.jpg" alt="터미널 분할" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[문서 →](https://fabrica-ai.vercel.app/docs/browser/design-mode)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/browser/design-mode"><picture><source srcset="../assets/feature-wall/design-mode.gif" type="image/gif"><img src="../assets/feature-wall/design-mode.jpg" alt="내장 브라우저와 디자인 모드" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[문서 →](https://fabrica-ai.vercel.app/docs/review/linear)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Fabrica의 GitHub 및 Linear 작업 워크플로" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[문서 →](https://fabrica-ai.vercel.app/docs/ssh)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/ssh"><picture><source srcset="../assets/feature-wall/ssh-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/ssh-worktrees.jpg" alt="SSH를 통한 원격 worktree" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
diff의 어느 줄에든 코멘트를 남기고 에이전트에게 바로 보내세요 — Fabrica를 떠나지 않고 리뷰하고 수정하고 커밋할 수 있습니다.

[문서 →](https://fabrica-ai.vercel.app/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/review/annotate-ai-diff"><picture><source srcset="../assets/feature-wall/annotate-diff.gif" type="image/gif"><img src="../assets/feature-wall/annotate-diff.jpg" alt="AI가 생성한 diff에 주석 달기" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[문서 →](https://fabrica-ai.vercel.app/docs/editing/file-explorer)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/editing/file-explorer"><picture><source srcset="../assets/feature-wall/file-drag.gif" type="image/gif"><img src="../assets/feature-wall/file-drag.jpg" alt="파일과 이미지를 에이전트 프롬프트로 드래그" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
에이전트도 Fabrica를 조작할 수 있습니다 — `fabrica worktree create`, `snapshot`, `click`, `fill`로 모든 워크플로를 스크립팅하세요.

[문서 →](https://fabrica-ai.vercel.app/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://fabrica-ai.vercel.app/docs/cli/overview"><picture><source srcset="../assets/feature-wall/fabrica-cli.gif" type="image/gif"><img src="../assets/feature-wall/fabrica-cli.jpg" alt="CLI에서 Fabrica 스크립팅" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[빠른 열기](https://fabrica-ai.vercel.app/docs/model/quick-open)** — 작업 흐름을 벗어나지 않고 worktree, 파일, 에이전트, 커맨드, 리포지토리 컨텍스트를 검색하세요.
- **[계정 전환 및 사용량 추적](https://fabrica-ai.vercel.app/docs/agents/usage-tracking)** — Claude와 Codex의 사용량과 rate limit 초기화 시점을 확인하고, 다시 로그인하지 않고 계정을 바로 전환하세요.
- **[풍부한 리포지토리 미리보기](https://fabrica-ai.vercel.app/docs/editing/markdown)** — Markdown, 이미지, PDF, 리포지토리 문서를 워크스페이스에서 미리 볼 수 있습니다.
- **[Computer Use](https://fabrica-ai.vercel.app/docs/cli/computer-use)** — 워크플로에 실제 상호작용이 필요할 때 에이전트가 데스크톱 앱과 화면에 보이는 UI를 직접 조작하게 하세요.
- **[알림과 읽지 않음 상태](https://fabrica-ai.vercel.app/docs/notifications)** — 에이전트가 완료되거나 주의가 필요할 때 알림을 받고, 스레드를 읽지 않음으로 표시해 나중에 다시 확인하세요.
- **그리고 훨씬 더 많은 기능** — 새로운 기능이 매일 출시되므로 이 목록은 늘 한 발 늦습니다. 진짜 기능은 [체인지로그](https://github.com/Auto-Scalers/Fabrica-app/releases)에서 확인하세요.

---

## 지원 에이전트

**모든 CLI 에이전트**와 함께 작동합니다 — 터미널에서 실행되는 에이전트라면 Fabrica에서도 실행됩니다.
...
- **iOS:** [App Store에서 다운로드](https://apps.apple.com/us/app/fabrica-ide/id6766130217)
- **Android:** [APK 다운로드](https://github.com/Auto-Scalers/Fabrica-app/releases/download/mobile-android-v0.0.37/app-release.apk)
...
- **Twitter / X:** 업데이트와 공지는 **[@fabrica_build](https://x.com/fabrica_build)** 를 팔로우하세요.
- **피드백과 아이디어:** 우리는 빠르게 출시합니다. 필요한 기능이 있나요? [새 기능을 요청](https://github.com/Auto-Scalers/Fabrica-app/issues)하세요.
- **개인정보 보호:** Fabrica가 수집하는 익명 사용 데이터와 수집 거부 방법은 [개인정보 및 텔레메트리 문서](https://fabrica-ai.vercel.app/docs/telemetry)를 참고하세요.
- **응원하기:** 이 리포지토리에 [Star](https://github.com/Auto-Scalers/Fabrica-app)를 눌러 매일 공개되는 릴리스 소식을 확인해 주세요.
...
<a href="https://github.com/Auto-Scalers/Fabrica-app/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Auto-Scalers/Fabrica-app" alt="Fabrica 기여자" />
</a>

## 라이선스

Fabrica는 [MIT 라이선스](../../LICENSE)에 따라 자유롭게 사용할 수 있는 오픈 소스입니다.
